...
const SEED_NEWS: NewsItem[] = [
  {
    ...
    summary:
      "The SEC has approved options trading on spot Bitcoin ETFs, opening the door for institutional hedging strategies and increased liquidity.",
  },
  {
    id: "n-2",
    ...
    summary:
      "The Fed maintained its benchmark rate, citing persistent services inflation. Dot plot signals one cut in H2 2026.",
  },
  {
    id: "n-3",
    ...
    summary:
      "Core developers confirmed the Pectra upgrade date. EIP-7702 introduces account abstraction natively, expected to reduce L2 gas costs by 40%.",
  },
  {
    id: "n-4",
    ...
    summary:
      "The Aave community voted to implement unified liquidity layers across all supported chains, consolidating fragmented pools.",
  },
  {
    id: "n-5",
    ...
    summary:
      "March CPI print of 2.8% was below the 3.0% consensus. Core CPI at 3.1% also beat expectations, fueling rate-cut optimism.",
  },
  {
    id: "n-6",
    ...
    summary:
      "Binance will delist LOOM/USDT, KEY/USDT, and 3 other pairs effective April 1 due to insufficient liquidity.",
  },
  {
    id: "n-7",
    ...
    summary:
      "48 teams drawn into 12 groups. USA, Mexico, and Canada placed in separate groups as co-hosts. Betting markets adjust outright odds.",
  },
  {
    id: "n-8",
    ...
    summary:
      "Custom hook contracts on Uniswap V4 attracted $2B TVL, with concentrated liquidity management hooks leading adoption.",
  },
  {
    id: "n-9",
    ...
    summary:
      "Bank of Japan raised rates by 25bps citing wage growth. USD/JPY dropped 2% to 138.50, pressuring carry trades.",
  },
  {
    id: "n-10",
    ...
    summary:
      "MicroStrategy purchased an additional 12,000 BTC at an average price of $87,500, bringing total holdings to 520,000 BTC.",
  },
  {
    id: "n-11",
    ...
    summary:
      "Marquee matchup sees Liverpool face Real Madrid. Betting markets price Liverpool slight favorites at 1.85.",
  },
  {
    id: "n-12",
    ...
    summary:
      "A consensus bug caused Solana mainnet to halt for 45 minutes. Validators coordinated restart; SOL dropped 8% before recovering.",
  },
  {
    id: "n-13",
    ...
    summary:
      "Full MiCA enforcement begins for stablecoin issuers in the EU. Tether applies for e-money license; Circle already compliant.",
  },
  {
    id: "n-14",
    ...
    summary:
      "Goldman Sachs Digital Assets division begins offering custody, lending, and execution services for institutional crypto clients.",
  },
  {
    id: "n-15",
    ...
    summary:
      "BCCI reports 800M projected viewers for IPL opener. Sports betting volumes expected to surge 35% over last season.",
  },
];
