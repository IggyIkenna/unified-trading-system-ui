...
export const MOCK_REBALANCE_PREVIEW: RebalancePreview = {
  ...
  allocations: [
    ...
    {
      strategy_id: "STAKED_BASIS",
      current_balance_usd: 250000,
      proposed_change_usd: 55000,
      instructions: [],
    },
    {
      strategy_id: "RECURSIVE_STAKED_BASIS",
...
export const MOCK_TRADE_HISTORY: TradeHistoryRow[] = [
  ...
  // --- STAKED_BASIS: USDT → weETH (SOR) + USDC margin to Hyperliquid + perp short ---
  {
    seq: 9,
    ...
    amount: 90000,
    price: 1,
    expected_output: 29.8,
    actual_output: 29.75,
    instant_pnl: {
      gross_pnl: 0,
      price_slippage_usd: -45,
      gas_cost_usd: 25,
      trading_fee_usd: 0,
      bridge_fee_usd: 0,
      net_pnl: -70,
