...
export const STRATEGIES: Strategy[] = [
  ...
  // ============================================
  {
    ...
    instruments: [
      {
        key: "WALLET:SPOT_ASSET:USDT",
        venue: "Wallet",
        type: "SPOT_ASSET",
        role: "Initial capital",
      },
      {
        key: "WALLET:SPOT_ASSET:ETH",
        venue: "Wallet",
        type: "SPOT_ASSET",
        role: "Long leg",
      },
    ...
    featuresConsumed: [
      ...
      {
        name: "eth_price",
        source: "market-tick-data",
        sla: "1s",
        usedFor: "Position sizing, PnL",
      },
      {
        name: "basis_bps",
        source: "features-delta-one",
        sla: "10s",
        usedFor: "Spread monitoring",
      },
    ],
    dataArchitecture: {
    ...
    pnlAttribution: {
      components: [
        ...
        },
        {
          id: "trading_pnl",
          label: "Trading P&L",
          settlementType: "REALIZED",
          description: "Entry/exit fills",
          color: "#a78bfa",
        },
        {
          id: "transaction_costs",
          label: "Transaction Costs",
          settlementType: "PER_FILL",
          description: "Swap fee + gas + taker fee",
          color: "#ef4444",
        },
      ],
    ...
    riskSubscriptions: [
      {
        ...
        subscribed: true,
        threshold: "2% drift",
        action: "Adjust perp size",
      },
      {
        riskType: "funding",
        subscribed: true,
        threshold: "min_funding_rate",
        action: "Entry/exit decision",
      },
      {
        riskType: "basis",
        subscribed: true,
        threshold: "max_basis_deviation",
        action: "Entry/exit decision",
      },
      {
    ...
    testingStatus: [
      { stage: "MOCK", status: "pending", notes: "Need MockDeFiDynamics" },
      {
        stage: "HISTORICAL",
        status: "pending",
        notes: "Need Hyperliquid funding history",
      },
      {
        stage: "LIVE_MOCK",
        status: "blocked",
        notes: "Blocked by feature computation",
      },
    ...
    configParams: [
      ...
      },
      {
        ...
        value: "0.0001",
        description: "Minimum funding rate to enter",
      },
      {
        key: "max_basis_deviation",
        value: "0.005",
        description: "Max basis spread to enter",
      },
      { key: "hedge_ratio", value: "1.0", description: "Delta hedge ratio" },
      {
        key: "spot_allocation_pct",
        value: "0.90",
        description: "Percentage allocated to spot",
      },
      {
        key: "margin_allocation_pct",
        value: "0.10",
        description: "Percentage for perp margin",
      },
    ],
  ...
  // ============================================
  {
    ...
    instruments: [
      ...
      {
        key: "AAVEV3-ETHEREUM:A_TOKEN:AWEETH@ETHEREUM",
        venue: "Aave V3",
        type: "aToken",
        role: "Collateral (leveraged)",
      },
      {
        key: "AAVEV3-ETHEREUM:DEBT_TOKEN:DEBTWETH@ETHEREUM",
        venue: "Aave V3",
        type: "debtToken",
        role: "Debt (negative)",
      },
      {
        ...
        venue: "Hyperliquid",
        type: "Perp",
        role: "Short leg (leveraged)",
      },
    ],
    featuresConsumed: [
      {
        name: "lst_staking_apy",
        source: "features-onchain",
        sla: "60s",
        usedFor: "Signal: staking yield component",
      },
      {
        name: "funding_rate",
        source: "features-delta-one",
        sla: "10s",
        usedFor: "Signal: funding yield component",
      },
      {
        name: "weeth_eth_rate",
        source: "features-onchain",
        sla: "60s",
        usedFor: "Position sizing, rebalancing",
      },
      {
        name: "aave_borrow_apy_eth",
        source: "features-onchain",
        sla: "60s",
        usedFor: "Cost: leverage cost",
      },
      {
        name: "health_factor",
        source: "features-onchain",
        sla: "60s",
        usedFor: "Risk: liquidation proximity",
      },
      {
        name: "morpho_flash_loan_liquidity",
        source: "features-onchain",
        sla: "60s",
        usedFor: "Pre-check: flash loan available",
      },
    ],
    dataArchitecture: {
      rawDataSource: "CloudDataProvider (live) / CSVDataProvider (backtest)",
    ...
    pnlAttribution: {
      components: [
        {
          id: "staking_yield_pnl",
          label: "Staking Yield (Leveraged)",
          settlementType: "LST_YIELD",
          description: "weETH rate appreciation x leverage",
          color: "#4ade80",
        },
        {
          id: "lending_yield_pnl",
          label: "Lending Yield",
          settlementType: "AAVE_INDEX",
          description: "aweETH liquidity index growth",
          color: "#22d3ee",
        },
        {
          id: "borrow_cost_pnl",
          label: "Borrow Cost",
          settlementType: "AAVE_INDEX",
          description: "debtWETH balance growth (negative)",
          color: "#ef4444",
        },
        {
          id: "funding_pnl",
          label: "Funding P&L (Leveraged)",
          settlementType: "FUNDING_8H",
          description: "Short perp funding x leverage",
          color: "#60a5fa",
        },
        {
          id: "rewards_pnl",
          label: "Rewards",
          settlementType: "SEASONAL_WEEKLY",
          description: "EtherFi/EIGEN weekly",
          color: "#fbbf24",
        },
        {
          id: "transaction_costs",
          label: "Transaction Costs",
          settlementType: "PER_FILL",
          description: "Flash loan fee + gas + slippage",
          color: "#dc2626",
        },
      ],
    ...
    riskSubscriptions: [
      {
        riskType: "aave_liquidation",
        subscribed: true,
        threshold: "HF < 1.5 deleverage, HF < 1.2 exit",
        action: "Atomic deleverage bundle",
      },
      {
        riskType: "delta",
        subscribed: true,
      ...
      },
      {
        ...
        subscribed: true,
        threshold: "weETH depeg > 2%",
        action: "Emergency exit",
      },
      {
        riskType: "liquidity",
        subscribed: true,
        threshold: "Flash loan < required",
        action: "Cannot rebalance atomically",
      },
    ],
    testingStatus: [
    ...
    configParams: [
      ...
      },
      {
        key: "target_leverage",
        value: "2.5",
        description: "Target leverage multiple",
      },
      {
        key: "min_health_factor",
        value: "1.2",
        description: "Emergency exit threshold",
      },
      {
        key: "target_health_factor",
        value: "1.5",
        description: "Target operating HF",
      },
      {
        key: "min_staking_apy",
        value: "0.03",
        description: "Minimum staking APY to enter",
      },
      {
  ...
  // ============================================
  {
    ...
    instruments: [
      {
        key: "UNISWAPV3-ETHEREUM:LP_POSITION:ETH-USDT@ETHEREUM",
        venue: "Uniswap V3",
        type: "LP NFT",
        role: "Active LP position",
      },
      {
        key: "WALLET:SPOT_ASSET:ETH",
        venue: "Wallet",
        type: "SPOT_ASSET",
        role: "Deposited asset",
      },
      {
        key: "WALLET:SPOT_ASSET:USDT",
        venue: "Wallet",
    ...
    featuresConsumed: [
      {
        ...
        source: "features-onchain",
        sla: "12s",
        usedFor: "Rebalance trigger",
      },
      {
        name: "current_tick",
        source: "features-onchain",
        sla: "12s",
        usedFor: "Range vs position check",
      },
      {
        name: "fee_apy_24h",
        source: "features-onchain",
        sla: "1h",
        usedFor: "Is LP profitable?",
      },
      {
        name: "il_pct",
        source: "features-onchain",
        sla: "12s",
        usedFor: "IL monitoring",
      },
      {
        name: "realized_vol",
        source: "features-volatility",
        sla: "5m",
        usedFor: "Range width decision",
      },
    ],
    dataArchitecture: {
      ...
      legs: [
        {
          name: "Pool selection",
          sorEnabled: true,
          allowedVenues: ["UNISWAPV3-ETHEREUM"],
        },
      ],
    },
    pnlAttribution: {
      components: [
        {
          id: "fee_income_pnl",
          label: "Fee Income",
          settlementType: "LP_FEE_ACCRUAL",
          description: "Fees from swappers",
          color: "#4ade80",
        },
        {
          id: "il_pnl",
          ...
          settlementType: "MARK_TO_MARKET",
          description: "Price divergence loss",
          color: "#ef4444",
        },
        {
          id: "inventory_pnl",
          label: "Inventory P&L",
          settlementType: "MARK_TO_MARKET",
          description: "Underlying value change",
          color: "#60a5fa",
        },
        {
          id: "transaction_costs",
          label: "Gas Costs",
          settlementType: "PER_FILL",
          description: "Add/remove/rebalance gas",
          color: "#dc2626",
        },
      ],
    ...
    riskSubscriptions: [
      {
        ...
        subscribed: true,
        threshold: "IL > X%",
        action: "Widen range or exit",
      },
      {
        riskType: "protocol_risk",
        subscribed: true,
        threshold: "Pool manipulation",
        action: "Emergency exit",
      },
      {
        riskType: "delta",
        subscribed: true,
        threshold: "Price exits range",
        action: "Rebalance to new range",
      },
      {
        riskType: "concentration",
        subscribed: true,
        threshold: "Pool TVL share > X%",
    ...
    testingStatus: [
      ...
      { stage: "HISTORICAL", status: "pending", notes: "Via The Graph" },
      {
        stage: "LIVE_MOCK",
        status: "blocked",
        notes: "Blocked by ADD_LIQUIDITY operation type",
      },
      { stage: "LIVE_TESTNET", status: "pending" },
      { stage: "STAGING", status: "pending" },
      { stage: "LIVE_REAL", status: "done" },
    ...
    configParams: [
      ...
      {
        key: "tick_range_lower",
        value: "-2000",
        description: "Lower tick offset from current",
      },
      {
        key: "tick_range_upper",
        value: "2000",
        description: "Upper tick offset from current",
      },
      {
        key: "rebalance_threshold_pct",
        value: "0.05",
        description: "Price exit % to trigger rebalance",
      },
      {
        key: "max_il_threshold",
        value: "0.08",
        description: "Max IL before exit",
      },
  ...
  // ============================================
  {
    ...
    instruments: [
      {
        key: "BINANCE:SPOT:BTC-USDT",
        venue: "Binance",
        type: "SPOT_ASSET",
        role: "Quoted pair",
      },
      {
        key: "BINANCE:SPOT:USDT",
        venue: "Binance",
        type: "SPOT_ASSET",
        role: "Quote currency",
      },
      {
        key: "BINANCE:SPOT:BTC",
        venue: "Binance",
        type: "SPOT_ASSET",
        role: "Base inventory",
      },
    ...
    featuresConsumed: [
      {
        ...
        source: "features-mm",
        sla: "5ms",
        usedFor: "Recalculate quotes",
      },
      {
        name: "bid_ask_spread",
        source: "features-delta-one",
        sla: "5ms",
        usedFor: "Spread decision",
      },
      {
        name: "realized_vol",
        source: "features-volatility",
        sla: "1m",
        usedFor: "Spread widening in high vol",
      },
      {
        name: "orderbook_imbalance",
        source: "features-mm",
        sla: "5ms",
        usedFor: "Skew adjustment",
      },
      {
        name: "inventory_skew",
        source: "ExposureMonitor",
        sla: "10ms",
        usedFor: "Inventory management",
      },
    ],
    dataArchitecture: {
      ...
      components: [
        {
          ...
          label: "Spread P&L",
          settlementType: "PER_FILL",
          description: "Ask fill - Bid fill prices",
          color: "#4ade80",
        },
        {
          id: "inventory_pnl",
        ...
        },
        {
          ...
          label: "Trading P&L",
          settlementType: "REALIZED",
          description: "Inventory management trades",
          color: "#a78bfa",
        },
        {
          id: "transaction_costs",
    ...
    riskSubscriptions: [
      {
        riskType: "delta",
        subscribed: true,
        threshold: "Inventory skew > max",
        action: "Skew quotes",
      },
      {
        riskType: "liquidity",
        subscribed: true,
        threshold: "Spread widens beyond max",
        action: "Widen or pause",
      },
      {
        riskType: "venue_protocol",
        subscribed: true,
        threshold: "Exchange circuit breaker",
        action: "Cancel all orders",
      },
      {
        riskType: "concentration",
        subscribed: true,
        threshold: "Too much inventory",
        action: "Reduce position",
      },
    ],
    testingStatus: [
    ...
    configParams: [
      {
        key: "spread_min_bps",
        value: "5",
        description: "Minimum spread to quote",
      },
      {
        key: "spread_max_bps",
        value: "20",
        description: "Maximum spread to quote",
      },
      {
      ...
      {
        key: "inventory_target_pct",
        value: "0.5",
        description: "Target 50/50 BTC/USDT",
      },
      {
        key: "move_threshold_bps",
        value: "5",
        description: "Recalculate on 5bp move",
      },
      {
        key: "skew_factor",
        value: "0.3",
        description: "Inventory skew adjustment",
      },
    ],
    venues: ["BINANCE"],
    performance: {
  ...
  // ============================================
  {
    ...
    instruments: [
      {
        key: "DERIBIT:OPTION:ETH-*",
        venue: "Deribit",
        type: "Option",
        role: "Multi-strike quoting",
      },
      {
        key: "DERIBIT:PERPETUAL:ETH-USD",
        venue: "Deribit",
        type: "Perp",
        role: "Delta hedge",
      },
    ...
    featuresConsumed: [
      {
        ...
        source: "features-delta-one",
        sla: "5ms",
        usedFor: "Reprice all options",
      },
      {
        name: "iv_surface",
        source: "features-volatility",
        sla: "1m",
        usedFor: "Option pricing model",
      },
      {
        name: "realized_vol",
        source: "features-volatility",
        sla: "5m",
        usedFor: "Vol edge calculation",
      },
      {
        name: "skew",
        source: "features-volatility",
        sla: "5ms",
        usedFor: "Strike-level adjustments",
      },
      {
        name: "portfolio_greeks",
        source: "ExposureMonitor",
        sla: "10ms",
        usedFor: "Delta hedge trigger",
      },
    ],
    dataArchitecture: {
      rawDataSource: "NEVER direct - via features service",
    ...
    pnlAttribution: {
      components: [
        ...
        },
        {
          ...
          description: "Time decay collection",
          color: "#60a5fa",
        },
        {
          id: "vega_pnl",
        ...
        },
        {
          ...
          label: "Hedge Cost",
          settlementType: "PER_FILL",
          description: "Delta hedge slippage",
          color: "#ef4444",
        },
      ],
    ...
    riskSubscriptions: [
      {
        riskType: "delta",
        subscribed: true,
        threshold: "Portfolio delta > hedge threshold",
        action: "Hedge underlying",
      },
      {
        riskType: "gamma",
        subscribed: true,
        threshold: "Gamma exposure > max",
        action: "Reduce near-ATM positions",
      },
      {
        riskType: "vega",
        subscribed: true,
        threshold: "Vega exposure > max",
        action: "Reduce vol exposure",
      },
      {
        riskType: "theta",
        subscribed: true,
        threshold: "Monitoring",
        action: "Expected daily P&L",
      },
      {
        riskType: "venue_protocol",
        subscribed: true,
        threshold: "Exchange issues",
        action: "Cancel all (mass pull)",
      },
    ],
    testingStatus: [
    ...
    configParams: [
      ...
      {
        key: "delta_hedge_threshold",
        value: "0.5",
        description: "Hedge when |delta| > 0.5",
      },
      {
        key: "max_gamma_exposure",
        value: "100000",
        description: "Max gamma in USD terms",
      },
      {
        key: "max_vega_exposure",
        value: "50000",
        description: "Max vega in USD terms",
      },
      {
        key: "strikes_per_expiry",
        value: "10",
        description: "Number of strikes to quote",
      },
    ],
    venues: ["DERIBIT"],
    performance: {
  ...
  // ============================================
  {
    ...
    instruments: [
      {
        key: "NASDAQ:EQUITY:SPY",
        venue: "IBKR",
        type: "SPOT_ASSET",
        role: "SPY directional",
      },
    ],
    featuresConsumed: [
      {
    ...
    pnlAttribution: {
      components: [
        {
          id: "directional_pnl",
          label: "Directional P&L",
          settlementType: "MARK_TO_MARKET",
          description: "Price change in direction",
          color: "#4ade80",
        },
        {
          id: "transaction_cost",
          label: "Commissions",
          settlementType: "PER_TRADE",
          description: "IBKR commissions + spread",
          color: "#ef4444",
        },
        {
          id: "slippage",
    ...
    riskSubscriptions: [
      {
        riskType: "delta",
        subscribed: true,
        threshold: "max_portfolio_exposure_pct",
        action: "Reduce position to cap",
      },
      {
        riskType: "drawdown",
        subscribed: true,
    ...
    configParams: [
      ...
      },
      {
        ...
        value: "0.15",
        description: "Max 15% of portfolio",
      },
      {
      ...
      {
        key: "rebalance_interval_bars",
        value: "12",
        description: "Rebalance every 12 bars",
      },
    ],
    venues: ["IBKR", "NASDAQ"],
    performance: {
  ...
  // ============================================
  {
    ...
    instruments: [
      {
        key: "PINNACLE:FIXED_ODDS:FOOTBALL",
        venue: "Pinnacle",
        type: "Fixed Odds",
        role: "Sharp line reference",
      },
      {
        key: "BETFAIR:EXCHANGE_ODDS:FOOTBALL",
        venue: "Betfair",
        type: "Exchange Odds",
        role: "Exchange execution",
      },
      {
        key: "BET365:FIXED_ODDS:FOOTBALL",
        venue: "Bet365",
        type: "Fixed Odds",
        role: "Soft line execution",
      },
    ],
    featuresConsumed: [
      {
        name: "odds_snapshot",
        source: "features-sports",
        sla: "1s",
        usedFor: "Arbitrage detection",
      },
      {
        name: "line_movement",
        source: "features-sports",
        sla: "1s",
        usedFor: "Sharp vs soft divergence",
      },
      {
        name: "match_state",
        source: "features-sports",
        sla: "5s",
        usedFor: "In-play vs pre-match",
      },
      {
        name: "kelly_edge",
        source: "features-sports",
      ...
      legs: [
        {
          name: "Back leg",
          sorEnabled: true,
          allowedVenues: ["PINNACLE", "BET365", "BETFAIR"],
        },
        {
          name: "Lay leg",
          sorEnabled: true,
          allowedVenues: ["BETFAIR", "SMARKETS"],
        },
      ],
    },
    pnlAttribution: {
      components: [
        {
          id: "arb_pnl",
          label: "Arbitrage P&L",
          settlementType: "MATCH_SETTLEMENT",
          description: "Guaranteed profit from arb",
          color: "#4ade80",
        },
        {
          id: "execution_cost",
          ...
          settlementType: "PER_FILL",
          description: "Betfair commission, spreads",
          color: "#ef4444",
        },
        {
          id: "voided_bets",
          label: "Voided/Adjusted",
          settlementType: "SETTLEMENT",
          description: "Rule 4 deductions, voids",
          color: "#fbbf24",
        },
      ],
    ...
    riskSubscriptions: [
      {
        riskType: "edge_decay",
        subscribed: true,
        threshold: "Arb closes before execution",
        action: "Cancel unmatched",
      },
      {
        riskType: "venue_protocol",
        subscribed: true,
        threshold: "Account limited/banned",
        action: "Remove venue from rotation",
      },
      {
        riskType: "market_suspension",
        subscribed: true,
        threshold: "Match suspended",
        action: "Hedge or accept exposure",
      },
    ],
    testingStatus: [
    ...
    configParams: [
      ...
      {
        key: "max_stake_per_bet",
        value: "5000",
        description: "Max stake per leg",
      },
      {
        key: "max_exposure_per_match",
        value: "10000",
        description: "Max total exposure",
      },
      {
        key: "venues_enabled",
        value: "PINNACLE,BETFAIR,BET365",
        description: "Active venues",
      },
      {
        key: "market_types",
        value: "h2h,over_under",
  ...
  // ============================================
  {
    ...
    instruments: [
      ...
      {
        key: "HYPERLIQUID:PERPETUAL:BTC-USDC",
        venue: "Hyperliquid",
        type: "Perp",
        role: "Short leg (hedge)",
      },
      ...
      components: [
        {
          ...
          label: "Funding P&L",
          settlementType: "FUNDING_8H",
          description: "8H funding payments",
          color: "#4ade80",
        },
        {
          id: "basis_spread_pnl",
  ...
  // ============================================
  {
    ...
    instruments: [
      {
        key: "POLYMARKET:PREDICTION_MARKET:*",
        venue: "Polymarket",
        type: "SPOT_ASSET",
        role: "DeFi prediction market",
      },
      {
        key: "KALSHI:PREDICTION_MARKET:*",
        venue: "Kalshi",
        type: "SPOT_ASSET",
        role: "Regulated prediction market",
      },
    ],
    featuresConsumed: [
      {
        name: "poly_odds",
        source: "features-prediction",
        sla: "5s",
        usedFor: "Polymarket prices",
      },
      {
        name: "kalshi_odds",
        source: "features-prediction",
        sla: "5s",
        usedFor: "Kalshi prices",
      },
      {
        name: "arb_spread",
        source: "features-prediction",
        sla: "5s",
        usedFor: "Arb detection",
      },
    ],
    dataArchitecture: {
      ...
      legs: [
        {
          name: "Yes leg",
          sorEnabled: true,
          allowedVenues: ["POLYMARKET", "KALSHI"],
        },
        {
          name: "No leg",
          sorEnabled: true,
      ...
      components: [
        {
          id: "arb_pnl",
          label: "Arbitrage P&L",
          settlementType: "EVENT_SETTLEMENT",
          description: "Lock-in arb profit",
          color: "#4ade80",
        },
        {
          id: "gas_cost",
    ...
    riskSubscriptions: [
      {
        riskType: "edge_decay",
        subscribed: true,
        threshold: "Arb closes",
        action: "Cancel unmatched",
      },
      {
        riskType: "liquidity",
        subscribed: true,
        threshold: "Thin markets",
        action: "Reduce size",
      },
    ],
    testingStatus: [
    ...
    configParams: [
      ...
      {
        key: "max_position_per_event",
        value: "10000",
        description: "Max per event",
      },
      {
        key: "events_enabled",
        value: "POLITICS,SPORTS,CRYPTO",
  ...
  // ============================================
  {
    ...
    description:
      "Arbitrage BTC up/down prediction markets (Polymarket) against CeFi perpetuals and options on Binance/OKX/Deribit.",
    ...
    instruments: [
      {
        key: "POLYMARKET:PREDICTION_MARKET:BTC_ABOVE_100K",
        venue: "Polymarket",
        type: "SPOT_ASSET",
        role: "Binary up/down prediction",
      },
      {
        key: "BINANCE-FUTURES:PERPETUAL:BTCUSDT",
        venue: "Binance",
        type: "Perp",
        role: "Delta hedge / directional",
      },
      {
        key: "DERIBIT:OPTION:BTC-*",
        venue: "Deribit",
        type: "Option",
        role: "Synthetic binary via options",
      },
    ],
    featuresConsumed: [
      {
        name: "poly_btc_up_odds",
        source: "features-prediction",
        sla: "10s",
        usedFor: "Polymarket implied probability",
      },
      {
        name: "btc_perp_price",
        source: "features-cefi",
        sla: "100ms",
        usedFor: "CeFi perp mid price",
      },
      {
        name: "btc_options_iv",
        source: "features-cefi",
        sla: "5s",
        usedFor: "Options implied vol for binary pricing",
      },
      {
        name: "cross_asset_arb_signal",
        source: "features-prediction",
        sla: "10s",
        usedFor: "Arb detection signal",
      },
    ],
    dataArchitecture: {
    ...
    sorConfig: {
      legs: [
        ...
        },
        {
          name: "CeFi hedge leg",
          sorEnabled: true,
          allowedVenues: ["BINANCE", "OKX", "DERIBIT"],
        },
      ],
    },
    pnlAttribution: {
      components: [
        {
          id: "arb_pnl",
          label: "Cross-Asset Arb P&L",
          settlementType: "EVENT_SETTLEMENT",
          description: "Prediction vs derivatives arb profit",
          color: "#4ade80",
        },
        {
          id: "hedge_delta",
          ...
          settlementType: "PER_FILL",
          description: "Perp/options hedge adjustment",
          color: "#60a5fa",
        },
        {
          id: "gas_cost",
          ...
          settlementType: "PER_FILL",
          description: "Polymarket tx gas",
          color: "#ef4444",
        },
        {
          id: "funding",
          label: "Funding Rate",
          settlementType: "PER_INTERVAL",
          description: "Perp funding payments",
          color: "#fbbf24",
        },
      ],
    },
    ...
    riskSubscriptions: [
      {
        riskType: "cross_asset_basis",
        subscribed: true,
        threshold: ">5% divergence",
        action: "Scale in",
      },
      {
        riskType: "prediction_liquidity",
        subscribed: true,
        threshold: "<$50K depth",
        action: "Reduce size",
      },
      {
        riskType: "funding_spike",
        subscribed: true,
        threshold: ">0.1%/8h",
        action: "Hedge via options",
      },
    ],
    testingStatus: [
      { stage: "MOCK", status: "done" },
    ...
    configParams: [
      {
        key: "min_arb_edge_pct",
        value: "0.02",
        description: "Minimum 2% cross-asset edge",
      },
      {
        key: "max_prediction_position",
        value: "50000",
        description: "Max USDC in prediction leg",
      },
      {
        key: "hedge_ratio",
        value: "0.8",
        description: "Delta hedge ratio (0.8 = 80% hedged)",
      },
      {
        key: "rebalance_threshold_pct",
        value: "0.05",
        description: "Rebalance when delta drifts 5%",
      },
    ],
  ...
  // ============================================
  {
    ...
    instruments: [
      ...
      {
        key: "AAVEV3-ETHEREUM:A_TOKEN:AUSDT@ETHEREUM",
        venue: "Aave V3",
        type: "aToken",
        role: "Yield-bearing position",
      },
    ],
    featuresConsumed: [
      {
        ...
        source: "features-onchain",
        sla: "60s",
        usedFor: "Yield monitoring",
      },
      {
        name: "liquidity_index",
        source: "features-onchain",
        sla: "60s",
        usedFor: "Balance accrual",
      },
      {
        name: "utilization_rate",
        source: "features-onchain",
        sla: "60s",
        usedFor: "APY prediction",
      },
    ],
    dataArchitecture: {
      ...
      components: [
        {
          ...
          label: "Lending Yield",
          settlementType: "AAVE_INDEX",
          description: "Liquidity index growth",
          color: "#4ade80",
        },
        {
          id: "gas_cost",
          label: "Gas Cost",
          settlementType: "PER_FILL",
          description: "Deposit/withdraw gas",
          color: "#ef4444",
        },
      ],
    },
    ...
    riskSubscriptions: [
      {
        riskType: "protocol_risk",
        subscribed: true,
        threshold: "Aave exploit",
        action: "Emergency withdraw",
      },
      {
        riskType: "liquidity",
        subscribed: true,
        threshold: "Utilization 100%",
  ...
  // ML Directional BTC
  {
    ...
    instruments: [
      {
        ...
        venue: "Binance",
        type: "SPOT_ASSET",
        role: "Primary trading instrument",
      },
      {
        key: "OKX:PERPETUAL:BTC-USDT",
        venue: "OKX",
        type: "Perp",
        role: "Hedge/leverage",
      },
    ...
    featuresConsumed: [
      {
        ...
        sla: "5s",
        usedFor: "Direction prediction",
      },
      {
        name: "btc_price",
        source: "market-tick-data",
        sla: "100ms",
        usedFor: "Entry/exit timing",
      },
    ],
    dataArchitecture: {
      ...
      legs: [
        {
          name: "BTC trade",
          sorEnabled: true,
          allowedVenues: ["BINANCE", "OKX", "BYBIT"],
        },
      ],
    },
    pnlAttribution: {
      components: [
        {
          ...
          label: "Directional P&L",
          settlementType: "MARK_TO_MARKET",
          description: "Price direction capture",
          color: "#4ade80",
        },
        {
          id: "transaction_costs",
    ...
    latencyProfile: {
      dataToSignal: "100ms",
      signalToInstruction: "10ms",
      instructionToFill: "500ms",
      endToEnd: "~1s",
      coLocationNeeded: false,
    },
    riskSubscriptions: [
    ...
    configParams: [
      {
        ...
        value: "5000000",
        description: "Max position in USDT",
      },
    ],
  ...
  // NBA Halftime ML
  {
    ...
    instruments: [
      {
        key: "BETFAIR:EXCHANGE_ODDS:NBA",
        venue: "Betfair",
        type: "Exchange Odds",
        role: "Primary betting exchange",
      },
      {
        key: "PINNACLE:FIXED_ODDS:NBA",
        venue: "Pinnacle",
        type: "Fixed Odds",
        role: "Sharp book reference",
      },
    ],
    featuresConsumed: [
      {
      ...
      {
        name: "ml_prediction",
        source: "sports-ml-service",
        sla: "5s",
        usedFor: "Win probability",
      },
    ],
    dataArchitecture: {
    ...
    latencyProfile: {
      dataToSignal: "500ms",
      signalToInstruction: "50ms",
      instructionToFill: "1s",
      endToEnd: "~2s",
      coLocationNeeded: false,
    },
    riskSubscriptions: [
  ...
  // Morpho Lending
  {
    ...
    instruments: [
      {
        key: "MORPHO:SUPPLY:USDC@ETHEREUM",
        venue: "Morpho",
        type: "aToken",
        role: "Supplied asset",
      },
    ...
    latencyProfile: {
      dataToSignal: "1s",
      signalToInstruction: "100ms",
      instructionToFill: "15s",
      endToEnd: "~16s",
      coLocationNeeded: false,
    },
    riskSubscriptions: [
      {
        riskType: "protocol_risk",
        subscribed: true,
        threshold: "Smart contract risk",
        action: "Monitor audits",
      },
    ],
    testingStatus: [{ stage: "LIVE_REAL", status: "done" }],
    ...
    instruments: [
      {
        ...
        venue: "IBKR",
        type: "SPOT_ASSET",
        role: "Long duration bond ETF",
      },
      {
        key: "IBKR:ETF:IEF",
        venue: "IBKR",
        type: "SPOT_ASSET",
        role: "Intermediate duration ETF",
      },
    ],
    featuresConsumed: [
      {
        name: "yield_spread",
        source: "tradfi-data-service",
        sla: "1m",
        usedFor: "Mean reversion signal",
      },
      {
        name: "z_score",
        source: "features-volatility",
        sla: "1m",
        usedFor: "Entry/exit threshold",
      },
    ],
    dataArchitecture: {
      ...
      components: [
        {
          ...
          label: "Spread P&L",
          settlementType: "MARK_TO_MARKET",
          description: "Yield spread capture",
          color: "#4ade80",
        },
        {
          id: "commission",
  ...
  // ETH Momentum
  {
    ...
    instruments: [
      {
        key: "BINANCE:PERPETUAL:ETH-USDT",
        venue: "Binance",
        type: "Perp",
    ...
    featuresConsumed: [
      {
        ...
        source: "features-momentum",
        sla: "1m",
        usedFor: "Trend direction",
      },
      {
        name: "volatility",
        source: "features-volatility",
      ...
      legs: [
        {
          name: "ETH trade",
          sorEnabled: true,
          allowedVenues: ["BINANCE", "OKX", "COINBASE"],
        },
      ],
    },
    pnlAttribution: {
    ...
    configParams: [
      {
        key: "lookback_period",
        value: "20",
        description: "Momentum lookback in bars",
      },
    ],
  ...
  // SOL Momentum
  {
    ...
    instruments: [
      {
        key: "BINANCE:PERPETUAL:SOL-USDT",
        venue: "Binance",
        type: "Perp",
        role: "Primary instrument",
      },
  ...
  // Multi-Venue Arbitrage
  {
    ...
    instruments: [
      ...
      {
        key: "OKX:SPOT:BTC-USDT",
        venue: "OKX",
        type: "SPOT_ASSET",
        role: "Arb leg",
      },
      {
        key: "BYBIT:SPOT:BTC-USDT",
        venue: "Bybit",
        type: "SPOT_ASSET",
        role: "Arb leg",
      },
      {
        key: "COINBASE:SPOT:BTC-USD",
        venue: "Coinbase",
        type: "SPOT_ASSET",
        role: "Arb leg",
      },
    ...
    featuresConsumed: [
      {
        ...
        source: "market-tick-data",
        sla: "10ms",
        usedFor: "Price comparison",
      },
      {
        name: "arb_signal",
        source: "arb-detection-service",
        sla: "5ms",
        usedFor: "Opportunity detection",
      },
    ],
    dataArchitecture: {
      ...
      components: [
        {
          ...
          label: "Arbitrage P&L",
          settlementType: "PER_FILL",
          description: "Price difference capture",
          color: "#4ade80",
        },
        {
          id: "fees",
    ...
    latencyProfile: {
      dataToSignal: "5ms",
      signalToInstruction: "1ms",
      instructionToFill: "50ms",
      endToEnd: "~60ms",
      coLocationNeeded: true,
    },
    riskSubscriptions: [
    ...
    configParams: [
      {
        key: "min_spread_bps",
        value: "5",
        description: "Min spread to execute",
      },
    ],
  ...
  // ============================================
  {
    ...
    instruments: [
      {
        key: "BINANCE:PERPETUAL:AVAX-USDT",
        venue: "Binance",
        type: "Perp",
        role: "Primary instrument",
      },
  ...
  // ============================================
  {
    ...
    instruments: [
      {
        key: "OKX:SPOT:ETH-USDT",
        venue: "OKX",
        type: "SPOT_ASSET",
        role: "Primary pair",
      },
      {
        key: "OKX:SPOT:ETH-USDC",
        venue: "OKX",
        type: "SPOT_ASSET",
        role: "Secondary pair",
      },
    ...
    dataArchitecture: {
      rawDataSource: "OKX API",
      processedData: ["spread", "z_score"],
      interval: "4H",
      lowestGranularity: "4H",
      executionMode: "same_candle_exit",
    },
      ...
      components: [
        {
          ...
          label: "Spread P&L",
          settlementType: "MARK_TO_MARKET",
          description: "Spread convergence capture",
          color: "#4ade80",
        },
        {
          id: "fees",
  ...
  // ============================================
  {
    ...
    dataArchitecture: {
      rawDataSource: "Exchange WebSocket",
      processedData: ["mid_price", "orderbook_imbalance"],
      interval: "30S",
      lowestGranularity: "30S",
      executionMode: "hold_until_flip",
    },
    sorEnabled: false,
    pnlAttribution: {
    ...
    configParams: [
      {
        key: "spread_min_bps",
        value: "8",
        description: "Minimum spread in bps",
      },
    ],
    venues: ["BINANCE"],
    performance: {
  ...
  // ============================================
  {
    ...
    instruments: [
      {
        key: "HYPERLIQUID:PERPETUAL:LINK-PERP",
        venue: "Hyperliquid",
        type: "Perp",
        role: "Primary instrument",
      },
    ...
    dataArchitecture: {
      rawDataSource: "Hyperliquid WS",
      processedData: ["momentum"],
      interval: "2H",
      lowestGranularity: "2H",
      executionMode: "same_candle_exit",
    },
    sorEnabled: false,
    pnlAttribution: {
      ...
      components: [
        {
          ...
          label: "Spread P&L",
          settlementType: "MARK_TO_MARKET",
          description: "Mean reversion capture",
          color: "#4ade80",
        },
        {
          id: "fees",
  ...
  // ============================================
  {
    ...
    dataArchitecture: {
      rawDataSource: "CME / Databento",
      processedData: ["es_price", "ml_features"],
      interval: "30M",
      lowestGranularity: "30M",
      executionMode: "same_candle_exit",
    },
    sorEnabled: false,
    pnlAttribution: {
    ...
    latencyProfile: {
      dataToSignal: "50ms",
      signalToInstruction: "5ms",
      instructionToFill: "100ms",
      endToEnd: "~200ms",
      coLocationNeeded: false,
    },
    riskSubscriptions: [
  ...
  // ============================================
  {
    ...
    instruments: [
      ...
      {
        key: "CBOE:OPTION:SPY-C-500-20260320",
        venue: "CBOE",
        type: "Option",
        role: "Call option",
      },
    ...
    featuresConsumed: [
      {
        ...
        source: "features-volatility",
        sla: "1m",
        usedFor: "Options pricing",
      },
      {
        name: "ml_vol_prediction",
        source: "ml-inference-service",
        sla: "30s",
        usedFor: "Vol direction",
      },
    ],
    dataArchitecture: {
      rawDataSource: "CBOE / OPRA",
      processedData: ["iv_surface", "greeks"],
      interval: "1D",
      lowestGranularity: "1D",
      executionMode: "event_driven",
    },
      ...
      components: [
        {
          ...
          label: "Vega P&L",
          settlementType: "MARK_TO_MARKET",
          description: "Vol change capture",
          color: "#a78bfa",
        },
        {
          id: "theta_pnl",
  ...
  // ============================================
  {
    ...
    featuresConsumed: [
      ...
      },
      {
        ...
        source: "tradfi-data-service",
        sla: "1h",
        usedFor: "Supply/demand",
      },
    ],
    dataArchitecture: {
      rawDataSource: "CME / EIA",
      processedData: ["cl_price", "bz_price", "ml_features"],
      interval: "1H",
      lowestGranularity: "1H",
      executionMode: "same_candle_exit",
    },
    ...
    instruments: [
      {
        ...
        venue: "CME",
        type: "Future",
        role: "Gold futures underlying",
      },
      {
        key: "CME:OPTION:GC-C-2500-20260617",
        venue: "CME",
        type: "Option",
        role: "Gold call option",
      },
    ],
    featuresConsumed: [
      {
        ...
        source: "features-volatility",
        sla: "1m",
        usedFor: "Option pricing",
      },
      {
        name: "gold_price",
        source: "market-tick-data",
        sla: "100ms",
        usedFor: "Delta hedging",
      },
    ],
    dataArchitecture: {
      rawDataSource: "CME",
      processedData: ["gold_price", "iv_surface", "greeks"],
      interval: "Tick",
      lowestGranularity: "Tick",
      executionMode: "event_driven",
    },
  ...
  // ============================================
  {
    ...
    instruments: [
      {
        ...
        venue: "CME",
        type: "Future",
        role: "10Y Treasury futures",
      },
      {
        key: "CME:OPTION:ZN-P-110-20260918",
        venue: "CME",
        type: "Option",
        role: "Put option",
      },
    ...
    featuresConsumed: [
      ...
      },
      {
        ...
        source: "tradfi-data-service",
        sla: "5m",
        usedFor: "Rate structure",
      },
    ],
    dataArchitecture: {
      rawDataSource: "CME",
      processedData: ["zn_price", "iv_surface"],
      interval: "4H",
      lowestGranularity: "4H",
      executionMode: "same_candle_exit",
    },
  ...
  // ============================================
  {
    ...
    dataArchitecture: {
      rawDataSource: "CME",
      processedData: ["si_price", "ml_features"],
      interval: "2H",
      lowestGranularity: "2H",
      executionMode: "same_candle_exit",
    },
  ...
  // ============================================
  {
    ...
    instruments: [
      ...
      {
        key: "CBOE:OPTION:QQQ-C-480-20260320",
        venue: "CBOE",
        type: "Option",
        role: "Call option",
      },
    ...
    dataArchitecture: {
      rawDataSource: "CBOE / OPRA",
      processedData: ["qqq_price", "iv_surface"],
      interval: "5M",
  ...
  // ============================================
  {
    ...
    featuresConsumed: [
      ...
      },
      {
        ...
        source: "tradfi-data-service",
        sla: "1h",
        usedFor: "Macro inputs",
      },
    ],
    dataArchitecture: {
      rawDataSource: "CME",
      processedData: ["eurusd_price", "ml_features"],
      interval: "1H",
      lowestGranularity: "1H",
      executionMode: "same_candle_exit",
    },
  ...
  // ============================================
  {
    ...
    dataArchitecture: {
      rawDataSource: "CME",
      processedData: ["hg_price", "iv_surface"],
      interval: "1D",
      lowestGranularity: "1D",
      executionMode: "same_candle_exit",
    },
  ...
  // ============================================
  {
    ...
    instruments: [
      {
        key: "UNISWAPV3:SPOT:WBTC-USDC",
        venue: "Uniswap V3",
        type: "SPOT_ASSET",
        role: "Long leg",
      },
      {
        key: "UNISWAPV3:SPOT:WBTC-ETH",
        venue: "Uniswap V3",
        type: "SPOT_ASSET",
        role: "Cross pair",
      },
    ...
    dataArchitecture: {
      rawDataSource: "On-chain / Uniswap",
      processedData: ["wbtc_price", "basis_bps"],
      interval: "4H",
      lowestGranularity: "4H",
      executionMode: "same_candle_exit",
    },
      ...
      components: [
        {
          ...
          label: "Funding P&L",
          settlementType: "FUNDING_8H",
          description: "Funding rate capture",
          color: "#4ade80",
        },
        {
          id: "basis_spread_pnl",
  ...
  // ============================================
  {
    ...
    instruments: [
      {
        key: "LIDO:STAKED:STETH@ETHEREUM",
        venue: "Lido",
        type: "SPOT_ASSET",
        role: "Staking position",
      },
      {
        key: "WALLET:SPOT_ASSET:WSTETH",
        venue: "Wallet",
        type: "SPOT_ASSET",
        role: "Wrapped staked ETH",
      },
      {
        key: "WALLET:SPOT_ASSET:ETH",
        venue: "Wallet",
    ...
    featuresConsumed: [
      {
        ...
        source: "features-onchain",
        sla: "60s",
        usedFor: "Staking yield",
      },
      {
        name: "steth_discount",
        source: "features-onchain",
        sla: "60s",
        usedFor: "Peg monitoring",
      },
    ],
    dataArchitecture: {
      rawDataSource: "On-chain / Lido",
      processedData: ["staking_apy", "steth_discount"],
      interval: "1D",
      lowestGranularity: "1D",
      executionMode: "event_driven",
    },
      ...
      components: [
        {
          ...
          label: "Staking Yield",
          settlementType: "LST_YIELD",
          description: "stETH appreciation",
          color: "#4ade80",
        },
        {
          id: "funding_pnl",
          label: "Funding P&L",
          settlementType: "FUNDING_8H",
          description: "Short perp funding",
          color: "#60a5fa",
        },
        {
          id: "gas_cost",
  ...
  // ============================================
  {
    ...
    instruments: [
      {
        key: "AAVEV3-ETHEREUM:A_TOKEN:AWSTETH@ETHEREUM",
        venue: "Aave V3",
        type: "aToken",
        role: "Collateral",
      },
    ...
    dataArchitecture: {
      rawDataSource: "On-chain / Aave",
      processedData: ["health_factor", "staking_apy", "borrow_apy"],
      interval: "Per-block",
      lowestGranularity: "Per-block",
      executionMode: "event_driven",
    },
    sorEnabled: false,
    pnlAttribution: {
      components: [
        {
          ...
          label: "Staking Yield (Leveraged)",
          settlementType: "LST_YIELD",
          description: "wstETH rate x leverage",
          color: "#4ade80",
        },
        {
          id: "borrow_cost",
  ...
  // ============================================
  {
    ...
    instruments: [
      {
        key: "AAVEV3-ETHEREUM:A_TOKEN:AUSDC@ETHEREUM",
        venue: "Aave V3",
        type: "aToken",
        role: "USDC supply",
      },
      ...
      {
        key: "AAVEV3-ETHEREUM:A_TOKEN:ADAI@ETHEREUM",
        venue: "Aave V3",
        type: "aToken",
        role: "DAI supply",
      },
  ...
  // ============================================
  {
    ...
    instruments: [
      {
        key: "UNISWAPV3:LP:ARB-USDC",
        venue: "Uniswap V3",
        type: "LP NFT",
        role: "ARB/USDC LP",
      },
      {
        key: "UNISWAPV3:LP:ARB-ETH",
        venue: "Uniswap V3",
        type: "LP NFT",
        role: "ARB/ETH LP",
      },
    ...
    featuresConsumed: [
      ...
      },
      {
        ...
        source: "features-onchain",
        sla: "1h",
        usedFor: "Profitability check",
      },
    ],
    dataArchitecture: {
      rawDataSource: "On-chain / Uniswap",
      processedData: ["pool_price", "fee_apy"],
      interval: "4H",
      lowestGranularity: "4H",
      executionMode: "same_candle_exit",
    },
    ...
    pnlAttribution: {
      components: [
        ...
        },
        {
          ...
          label: "Impermanent Loss",
          settlementType: "MARK_TO_MARKET",
          description: "IL from price divergence",
          color: "#ef4444",
        },
        {
          id: "gas_cost",
  ...
  // ============================================
  {
    ...
    instruments: [
      {
        key: "BETFAIR:EXCHANGE_ODDS:EPL_MATCH_ODDS",
        venue: "Betfair",
        type: "Exchange Odds",
        role: "Exchange execution",
      },
      {
        key: "BETFAIR:EXCHANGE_ODDS:EPL_ASIAN_HANDICAP",
        venue: "Betfair",
        type: "Exchange Odds",
        role: "Asian handicap",
      },
    ...
    dataArchitecture: {
      rawDataSource: "Odds API",
      processedData: ["odds_snapshot", "arb_opportunities"],
      ...
      legs: [
        {
          name: "Back leg",
          sorEnabled: true,
          allowedVenues: ["BETFAIR", "PINNACLE"],
        },
        { name: "Lay leg", sorEnabled: true, allowedVenues: ["BETFAIR"] },
      ],
    },
    pnlAttribution: {
      components: [
  ...
  // ============================================
  {
    ...
    instruments: [
      {
        key: "BETFAIR:EXCHANGE_ODDS:NFL_MONEYLINE",
        venue: "Betfair",
        type: "Exchange Odds",
        role: "Moneyline",
      },
      {
        key: "BETFAIR:EXCHANGE_ODDS:NFL_TOTAL",
        venue: "Betfair",
        type: "Exchange Odds",
        role: "Totals",
      },
    ...
    featuresConsumed: [
      {
        ...
        source: "features-sports",
        sla: "1s",
        usedFor: "True probability estimate",
      },
      {
        name: "kelly_edge",
        source: "features-sports",
    ...
    dataArchitecture: {
      rawDataSource: "Odds API",
      processedData: ["sharp_odds", "soft_odds", "kelly_edge"],
      interval: "Game-driven",
      lowestGranularity: "Per-game",
      executionMode: "event_driven",
    },
      ...
      components: [
        {
          ...
          label: "Betting P&L",
          settlementType: "MATCH_SETTLEMENT",
          description: "Win/loss on value bets",
          color: "#4ade80",
        },
        {
          id: "commission",
  ...
  // ============================================
  {
    ...
    instruments: [
      {
        key: "SMARKETS:EXCHANGE_ODDS:LALIGA_MATCH_ODDS",
        venue: "Smarkets",
        type: "Exchange Odds",
        role: "Match odds",
      },
    ...
    dataArchitecture: {
      rawDataSource: "Sports API",
      processedData: ["ml_features", "ml_prediction"],
      interval: "Match-driven",
      lowestGranularity: "Per-match",
      executionMode: "event_driven",
    },
    sorEnabled: false,
    pnlAttribution: {
  ...
  // ============================================
  {
    ...
    instruments: [
      {
        key: "BETFAIR:EXCHANGE_ODDS:NBA_MONEYLINE",
        venue: "Betfair",
        type: "Exchange Odds",
        role: "Moneyline",
      },
      {
        key: "BETFAIR:EXCHANGE_ODDS:NBA_SPREAD",
        venue: "Betfair",
        type: "Exchange Odds",
        role: "Point spread",
      },
    ...
    dataArchitecture: {
      rawDataSource: "Sports API",
      processedData: ["live_score", "implied_probability"],
      interval: "Quarter-driven",
      lowestGranularity: "Per-quarter",
      executionMode: "event_driven",
    },
    sorEnabled: false,
    pnlAttribution: {
  ...
  // ============================================
  {
    ...
    instruments: [
      {
        key: "SMARKETS:EXCHANGE_ODDS:MLB_MONEYLINE",
        venue: "Smarkets",
        type: "Exchange Odds",
        role: "Moneyline",
      },
      {
        key: "SMARKETS:EXCHANGE_ODDS:MLB_RUN_LINE",
        venue: "Smarkets",
        type: "Exchange Odds",
        role: "Run line",
      },
    ...
    dataArchitecture: {
      rawDataSource: "Sports API",
      processedData: ["sharp_odds", "pitcher_data"],
      interval: "Game-driven",
      lowestGranularity: "Per-game",
      executionMode: "event_driven",
    },
      ...
      components: [
        {
          ...
          label: "Betting P&L",
          settlementType: "MATCH_SETTLEMENT",
          description: "Value bet wins/losses",
          color: "#4ade80",
        },
        {
          id: "commission",
  ...
  // ============================================
  {
    ...
    instruments: [
      {
        key: "BETFAIR:EXCHANGE_ODDS:SERIE_A_MATCH_ODDS",
        venue: "Betfair",
        type: "Exchange Odds",
        role: "Match odds",
      },
  ...
  // ============================================
  {
    ...
    instruments: [
      {
        key: "POLYMARKET:PREDICTION_MARKET:POLY_CPI_PRINT",
        venue: "Polymarket",
        type: "SPOT_ASSET",
        role: "CPI prediction",
      },
      {
        key: "POLYMARKET:PREDICTION_MARKET:POLY_NFP_ABOVE",
        venue: "Polymarket",
        type: "SPOT_ASSET",
        role: "NFP prediction",
      },
    ...
    dataArchitecture: {
      rawDataSource: "Polymarket API / FRED",
      processedData: ["ml_features", "event_probabilities"],
      interval: "4H",
      lowestGranularity: "4H",
      executionMode: "event_driven",
    },
      ...
      components: [
        {
          ...
          label: "Directional P&L",
          settlementType: "EVENT_SETTLEMENT",
          description: "Event outcome prediction",
          color: "#4ade80",
        },
        {
          id: "gas_cost",
  ...
  // ============================================
  {
    ...
    instruments: [
      {
        key: "POLYMARKET:PREDICTION_MARKET:POLY_ETH_ABOVE_5K",
        venue: "Polymarket",
        type: "SPOT_ASSET",
        role: "ETH prediction",
      },
      {
        key: "POLYMARKET:PREDICTION_MARKET:POLY_BTC_ABOVE_100K",
        venue: "Polymarket",
        type: "SPOT_ASSET",
        role: "BTC prediction",
      },
    ...
    featuresConsumed: [
      {
        ...
        source: "features-prediction",
        sla: "5s",
        usedFor: "Market prices",
      },
      {
        name: "cross_platform_spread",
        source: "features-prediction",
        sla: "5s",
        usedFor: "Arb detection",
      },
    ...
    dataArchitecture: {
      rawDataSource: "Polymarket API",
      processedData: ["poly_odds", "arb_spread"],
      interval: "1H",
      lowestGranularity: "1H",
      executionMode: "event_driven",
    },
      ...
      components: [
        {
          ...
          label: "Arb P&L",
          settlementType: "EVENT_SETTLEMENT",
          description: "Cross-platform arb",
          color: "#4ade80",
        },
        {
          id: "gas_cost",
  ...
  // ============================================
  {
    ...
    instruments: [
      {
        key: "BINANCE:PERPETUAL:SUI-USDT",
        venue: "Binance",
        type: "Perp",
        role: "Primary instrument",
      },
  ...
  // ============================================
  {
    ...
    description:
      "Back/lay quoting on Betfair exchange for EPL matches. Sub-second feature-to-strategy with tick-level rebalancing.",
    ...
    instruments: [
      {
        key: "BETFAIR:EXCHANGE:EPL_MATCH",
        venue: "Betfair",
        type: "Exchange Odds",
        role: "Back/lay quoting",
      },
    ],
    featuresConsumed: [
      {
        ...
        source: "features-sports",
        sla: "100ms",
        usedFor: "Best available back price",
      },
      {
        name: "best_lay",
        source: "features-sports",
        sla: "100ms",
        usedFor: "Best available lay price",
      },
      {
        name: "suspension_flag",
        source: "features-sports",
        sla: "100ms",
        usedFor: "Market suspension detection (goal/VAR)",
      },
      {
        name: "sharp_calibration",
        source: "features-sports",
        sla: "1s",
        usedFor: "Fair value calibration from sharp books",
      },
    ],
    dataArchitecture: {
      ...
      components: [
        {
          ...
          label: "Spread P&L",
          settlementType: "PER_FILL",
          description: "Captured back-lay spread",
          color: "#4ade80",
        },
        {
          id: "greening_pnl",
          label: "Greening P&L",
          settlementType: "REALIZED",
          description: "Profit locked by greening across outcomes",
          color: "#22d3ee",
        },
        {
          id: "inventory_pnl",
          label: "Inventory P&L",
          settlementType: "MARK_TO_MARKET",
          description: "MTM on unhedged inventory",
          color: "#60a5fa",
        },
        {
          id: "commission",
          label: "Commission",
          settlementType: "PER_FILL",
          description: "Betfair commission on net winnings",
          color: "#ef4444",
        },
      ],
    ...
    riskSubscriptions: [
      {
        ...
        subscribed: true,
        threshold: "CRITICAL",
        action: "Pause all quoting on goal/VAR/red card",
      },
      {
        riskType: "adverse_selection",
        subscribed: true,
        threshold: "Fill rate vs sharp move",
        action: "Widen spread or pull quotes",
      },
      {
        riskType: "inventory",
        subscribed: true,
        threshold: "Max exposure across outcomes",
        action: "Skew quotes to flatten",
      },
      {
        riskType: "venue_protocol",
        subscribed: true,
        threshold: "API disconnect / rate limit",
    ...
    testingStatus: [
      {
        stage: "MOCK",
        status: "in_progress",
        notes: "MockBetfairFeed under development",
      },
      { stage: "HISTORICAL", status: "pending" },
      { stage: "LIVE_MOCK", status: "pending" },
      { stage: "LIVE_TESTNET", status: "pending" },
    ...
    configParams: [
      ...
      {
        key: "max_exposure_per_outcome",
        value: "5000",
        description: "Max GBP per outcome",
      },
      {
        key: "greening_threshold_pct",
        value: "0.8",
        description: "Green at 80% of target profit",
      },
      {
        key: "suspension_cooldown_ms",
        value: "5000",
        description: "Wait 5s after suspension lifts",
      },
    ],
    venues: ["BETFAIR"],
    performance: {
  ...
  // ============================================
  {
    ...
    instruments: [
      {
        key: "WALLET:LST:WEETH",
        venue: "Wallet",
        type: "LST",
        role: "Staking yield (long leg)",
      },
      {
        key: "HYPERLIQUID:PERPETUAL:ETH-USD",
        venue: "Hyperliquid",
        type: "Perp",
        role: "Delta hedge (short leg)",
      },
    ],
    featuresConsumed: [
      {
        name: "lst_eth_exchange_rate",
        source: "features-onchain",
        sla: "60s",
        usedFor: "LST appreciation rate, rebalance trigger",
      },
      {
        name: "funding_rate",
        source: "features-delta-one",
        sla: "10s",
        usedFor: "Funding yield component",
      },
      {
        name: "eth_spot_price",
        source: "market-tick-data",
        sla: "1s",
        usedFor: "Delta calculation, position sizing",
      },
    ],
    dataArchitecture: {
      ...
      components: [
        {
          ...
          label: "Staking Yield",
          settlementType: "LST_YIELD",
          description: "weETH exchange rate appreciation",
          color: "#4ade80",
        },
        {
          id: "funding_pnl",
          label: "Funding P&L",
          settlementType: "FUNDING_8H",
          description: "Short perp funding payments received",
          color: "#60a5fa",
        },
        {
          id: "lst_depeg_pnl",
          label: "LST Depeg P&L",
          settlementType: "MARK_TO_MARKET",
          description: "MTM from weETH/ETH peg deviation",
          color: "#fbbf24",
        },
        {
          id: "trading_pnl",
          label: "Trading P&L",
          settlementType: "REALIZED",
          description: "Entry/exit execution P&L",
          color: "#a78bfa",
        },
        {
          id: "fees_gas",
          label: "Fees & Gas",
          settlementType: "PER_FILL",
          description: "DEX swap fees + on-chain gas",
          color: "#ef4444",
        },
      ],
    ...
    riskSubscriptions: [
      {
        ...
        subscribed: true,
        threshold: "2% drift",
        action: "Adjust perp size to re-hedge",
      },
      {
        riskType: "funding",
        subscribed: true,
        threshold: "Negative funding sustained >24h",
      ...
      },
      {
        ...
        subscribed: true,
        threshold: "weETH depeg > 2%",
        action: "Emergency exit LST position",
      },
      {
        riskType: "liquidity",
        subscribed: true,
        threshold: "weETH DEX liquidity < $1M",
    ...
    configParams: [
      ...
      },
      {
        key: "min_staking_apy",
        value: "0.03",
        description: "Min staking APY to enter",
      },
      {
        key: "min_funding_rate",
        value: "0.0001",
        description: "Min funding rate threshold",
      },
      {
        key: "max_depeg_pct",
        value: "0.02",
        description: "Max acceptable depeg before exit",
      },
      { key: "hedge_ratio", value: "1.0", description: "Delta hedge ratio" },
    ],
  ...
  // ============================================
  {
    ...
    instruments: [
      {
        key: "AAVE_V3:SUPPLY:USDC",
        venue: "Aave V3",
        type: "Supply",
        role: "Supplied USDC earning interest",
      },
    ],
    featuresConsumed: [
      {
        name: "aave_supply_apy",
        source: "features-onchain",
        sla: "60s",
        usedFor: "Yield monitoring, entry/exit decision",
      },
      {
        name: "aave_utilization",
        source: "features-onchain",
        sla: "60s",
        usedFor: "Pool utilization rate",
      },
      {
        name: "liquidity_index",
        source: "features-onchain",
        sla: "60s",
        usedFor: "Interest accrual tracking",
      },
    ],
    dataArchitecture: {
      ...
      components: [
        {
          ...
          settlementType: "AAVE_INDEX",
          description: "USDC supply interest via liquidity index",
          color: "#4ade80",
        },
        {
          id: "gas",
          label: "Gas Cost",
          settlementType: "PER_FILL",
          description: "Supply/withdraw transaction gas",
          color: "#ef4444",
        },
      ],
    ...
    riskSubscriptions: [
      {
        riskType: "protocol_risk",
        subscribed: true,
        threshold: "Aave governance / exploit",
        action: "Withdraw all",
      },
      {
        riskType: "liquidity",
        subscribed: true,
        threshold: "Utilization > 95% (withdraw queue)",
        action: "Monitor, reduce if sustained",
      },
      {
        riskType: "depeg",
        subscribed: true,
        threshold: "USDC depeg > 0.5%",
        action: "Evaluate exit to diversify stables",
      },
    ],
    testingStatus: [
      { stage: "MOCK", status: "pending" },
    ...
    configParams: [
      ...
      },
      {
        key: "min_supply_apy",
        value: "0.03",
        description: "Min 3% APY to stay supplied",
      },
      {
        key: "max_utilization",
        value: "0.95",
        description: "Withdraw if utilization exceeds 95%",
      },
      {
        key: "rebalance_interval_hours",
        value: "24",
        description: "Check rebalance every 24h",
      },
    ],
    venues: ["AAVEV3-ETHEREUM"],
    performance: {
...
export function generatePositionsForStrategy(strategy: Strategy): Position[] {
  ...
  strategy.instruments.forEach((inst, idx) => {
    ...
    const entryPrice =
      inst.type === "Perp" || inst.type === "SPOT_ASSET"
        ? inst.key.includes("BTC")
          ? 67245
          : inst.key.includes("ETH")
            ? 3245
            : 1
        : 1;
    ...
    positions.push({
      ...
      client: "Internal",
      underlying: inst.key.includes("BTC")
        ? "BTC"
        : inst.key.includes("ETH")
          ? "ETH"
          : inst.key.split(":")[2]?.split("-")[0] || "USDT",
      venue: inst.venue,
      instrument: inst.key,
