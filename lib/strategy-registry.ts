...
export const STRATEGIES: Strategy[] = [
  ...
  // ============================================
  {
    ...
    sorConfig: {
      legs: [
        { name: "USDT→ETH swap", sorEnabled: true, allowedVenues: ["UNISWAPV3-ETH", "CURVE-ETH", "BALANCER-ETH"] },
    ...
    venues: ["UNISWAPV3-ETH", "CURVE-ETH", "HYPERLIQUID"],
    performance: {
      pnlTotal: 892400,
      pnlMTD: 124500,
      sharpe: 2.34,
  ...
  // ============================================
  {
    ...
    instruments: [
      { key: "WALLET:SPOT_ASSET:USDT", venue: "Wallet", type: "SPOT_ASSET", role: "Initial capital" },
      { key: "AAVE_V3_ETH:A_TOKEN:AWEETH@ETHEREUM", venue: "Aave V3", type: "aToken", role: "Collateral (leveraged)" },
      { key: "AAVE_V3_ETH:DEBT_TOKEN:DEBTWETH@ETHEREUM", venue: "Aave V3", type: "debtToken", role: "Debt (negative)" },
    ...
    sorConfig: {
      legs: [
        { name: "WETH→weETH swap", sorEnabled: true, allowedVenues: ["CURVE-ETH", "BALANCER-ETH", "UNISWAPV3-ETH"] },
    ...
    venues: ["AAVE_V3_ETH", "MORPHO-ETHEREUM", "HYPERLIQUID", "CURVE-ETH"],
    performance: {
      pnlTotal: 1245000,
      pnlMTD: 198000,
      sharpe: 2.12,
  ...
  // ============================================
  {
    ...
    instruments: [
      { key: "UNISWAPV3-ETH:LP_POSITION:ETH-USDT@ETHEREUM", venue: "Uniswap V3", type: "LP NFT", role: "Active LP position" },
    ...
    sorConfig: {
      legs: [
        { name: "Pool selection", sorEnabled: true, allowedVenues: ["UNISWAPV3-ETH"] },
      ],
    },
    pnlAttribution: {
      components: [
...
id: "DEFI_AAVE_LEND_EVT_1D",
  ...
  executionMode: "EVT",
    ...
    instruments: [
      { key: "WALLET:SPOT_ASSET:USDT", venue: "Wallet", type: "SPOT_ASSET", role: "Initial capital" },
      { key: "AAVE_V3_ETH:A_TOKEN:AUSDT@ETHEREUM", venue: "Aave V3", type: "aToken", role: "Yield-bearing position" },
    ],
    featuresConsumed: [
