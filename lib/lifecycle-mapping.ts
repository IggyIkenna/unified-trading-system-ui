...
export const lifecycleStages: Record<LifecycleStage, {
  ...
  acquire: {
    label: "Acquire",
    description: "Data acquisition, ETL pipelines & venue coverage (Data Science)",
    icon: "Database",
    color: "text-sky-400",
  },
  build: {
    label: "Build",
    description: "Features, ML models, strategies & backtesting (Quant)",
    icon: "Wrench",
    color: "text-violet-400",
  },
  promote: {
    label: "Promote",
    description: "Multi-day strategy review & risk analysis (Trader + Risk)",
    icon: "ArrowUpCircle",
  ...
  observe: {
    label: "Observe",
    description: "Risk monitoring, alerts, news & system health (Risk / Ops)",
    icon: "Eye",
    color: "text-cyan-400",
  },
  manage: {
    label: "Manage",
    description: "Clients, mandates, fees & onboarding (Back Office)",
    icon: "Settings2",
    color: "text-rose-400",
  },
  report: {
    label: "Report",
    description: "P&L, settlement, invoicing & regulatory (Executive)",
    icon: "FileText",
