...
export type OperationType = "BUY" | "SELL" | "SWAP" | "LEND" | "BORROW" | "REPAY" | "WITHDRAW" | "DEPOSIT" | "REBALANCE" | "ADD_LIQUIDITY" | "REMOVE_LIQUIDITY" | "COLLECT_FEES"
export type InstructionType = "TRADE" | "SWAP" | "ZERO_ALPHA" | "PREDICTION_BET" | "SPORTS_BET" | "SPORTS_EXCHANGE_ORDER" | "FUTURES_ROLL" | "OPTIONS_COMBO" | "ADD_LIQUIDITY" | "REMOVE_LIQUIDITY" | "COLLECT_FEES"
...
export type VenueCategory = "cefi" | "tradfi" | "defi" | "onchain_perps" | "sports" | "prediction"
...
export function getVenueCategory(venue: string): VenueCategory | undefined {
  return (VENUE_CATEGORY_MAP as Record<string, string>)[venue] as VenueCategory | undefined
}
...
export function isExchangeVenue(venue: string): boolean {
  return (CLOB_VENUES as readonly string[]).includes(venue) ||
         (DEX_VENUES as readonly string[]).includes(venue)
}

export function isSportsVenue(venue: string): boolean {
  return (SPORTS_VENUES as readonly string[]).includes(venue) ||
...
export const SERVICES: Service[] = [
  ...
  { id: "pnl-attribution-service", name: "P&L Attribution Service", type: "batch-service", tier: 3, domain: "analytics", mode: "batch", capabilities: ["data_source", "data_sink", "event_bus"], status: "active", servesUi: null, coveragePct: 46 },
  { id: "market-data-processing-service", name: "Market Data Processing", type: "service", tier: 3, domain: "market-data", mode: "live", capabilities: ["data_source", "data_sink", "event_bus"], status: "active", servesUi: null, coveragePct: 39 },
  ...
  { id: "position-balance-monitor-service", name: "Position Balance Monitor", type: "service", tier: 3, domain: "settlement", mode: "live", capabilities: ["data_source", "event_bus"], status: "active", servesUi: null, coveragePct: 77 },
  { id: "ml-inference-service", name: "ML Inference Service", type: "service", tier: 3, domain: "ml", mode: "live", capabilities: ["data_source", "cache", "event_bus"], status: "active", servesUi: null, coveragePct: 75 },
  { id: "ml-training-service", name: "ML Training Service", type: "batch-service", tier: 3, domain: "ml", mode: "batch", capabilities: ["data_source", "data_sink"], status: "active", servesUi: null, coveragePct: 35 },
  ...
  { id: "ml-inference-api", name: "ML Inference API", type: "api-service", tier: 3, domain: "ml", mode: "live", capabilities: ["data_source", "cache"], status: "active", servesUi: ["ml-training-ui"], coveragePct: null },
  { id: "ml-training-api", name: "ML Training API", type: "api-service", tier: 3, domain: "ml", mode: "live", capabilities: ["data_source"], status: "active", servesUi: ["ml-training-ui"], coveragePct: null },
  { id: "market-data-api", name: "Market Data API", type: "api-service", tier: 3, domain: "market-data", mode: "live", capabilities: ["data_source", "event_bus"], status: "active", servesUi: ["trading-analytics-ui", "batch-audit-ui"], coveragePct: 77 },
  { id: "trading-analytics-api", name: "Trading Analytics API", type: "api-service", tier: 3, domain: "execution", mode: "live", capabilities: ["data_source", "cache"], status: "active", servesUi: ["trading-analytics-ui"], coveragePct: null },
]
