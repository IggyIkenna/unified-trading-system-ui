...
export const SERVICE_REGISTRY: readonly ServiceDefinition[] = [
  ...
  },
  {
    ...
    href: "/service/trading/positions",
    requiredEntitlements: ["execution-basic"],
    category: "trading",
    icon: "Wallet",
    internalOnly: false,
  },
  {
    ...
    href: "/service/execution/overview",
    requiredEntitlements: ["execution-basic"],
    category: "trading",
    icon: "Zap",
    internalOnly: false,
  ...
  // --- Research & Analytics ---
  {
    ...
    href: "/service/research/overview",
  ...
  },
  {
    ...
    href: "/service/manage/compliance",
    requiredEntitlements: ["*"],
    category: "ops",
    icon: "ClipboardCheck",
    internalOnly: true,
