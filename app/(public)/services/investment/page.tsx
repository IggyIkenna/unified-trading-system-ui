          ...
          <div className="mx-auto max-w-4xl">
            ...
            <Card className="mb-6 border-rose-500/20">
              ...
              <CardContent>
                ...
                <div className="space-y-2">
                  {[
                    { strategy: "Crypto Momentum", alloc: "35%", pnl: "+$84,200", attr: "+3.5%" },
                    { strategy: "TradFi Carry", alloc: "25%", pnl: "+$52,100", attr: "+2.2%" },
                    { strategy: "DeFi Yield", alloc: "20%", pnl: "+$41,800", attr: "+1.7%" },
                    { strategy: "Sports Arb", alloc: "20%", pnl: "+$38,400", attr: "+1.6%" },
                  ].map((row) => (
                    <div key={row.strategy} className="flex items-center justify-between rounded-lg border border-border/50 bg-muted/30 px-3 py-2 text-sm">
            ...
            <Card className="border-rose-500/20">
              ...
              <CardContent>
                <div className="space-y-2">
                  {[
                    { period: "Mar 2026", nav: "$2,416,500", perf: "+8.2%", fee: "$19,332", status: "Pending" },
                    { period: "Feb 2026", nav: "$2,232,800", perf: "+12.4%", fee: "$27,687", status: "Settled" },
                    { period: "Jan 2026", nav: "$1,986,200", perf: "+6.1%", fee: "$12,118", status: "Settled" },
                  ].map((row) => (
                    <div key={row.period} className="flex items-center justify-between rounded-lg border border-border/50 bg-muted/30 px-3 py-2 text-sm">
                      ...
                      <div className="flex items-center gap-4 font-mono text-xs">
                        ...
                        <Badge variant="outline" className={`text-[10px] ${row.status === "Settled" ? "border-emerald-500/30 text-emerald-400" : "border-amber-500/30 text-amber-400"}`}>
                          {row.status}
                        </Badge>
                      </div>
                    </div>
