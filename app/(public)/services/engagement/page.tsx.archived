...
const ENGAGEMENT_TIERS = [
  {
    ...
    services: [
      ...
      "Market Data API",
      "Historical Access",
      "Data Download (add-on)",
    ],
    bestFor:
      "Quant teams and data scientists who build their own models and execution. When you're ready to train models, backtest, or go live — the data is already there, instantly available on the same platform",
    cta: "Start with Data",
  },
  {
    id: "research",
    ...
    description:
      "Three layers in one subscription: train ML models to generate trading signals, configure strategy rules to act on those signals, and select execution algorithms to route orders. Simple algos (TWAP, VWAP) are included; advanced algos (IS, SOR, custom) are available as a bolt-on. Backtest the full pipeline across historical data before going live.",
    icon: Brain,
    pricing: "Contact us",
    ...
    bestFor:
      "Quant funds building systematic strategies who want the full ML → signal → algo → execution pipeline handled",
  ...
  },
  {
    ...
    description:
      "Deploy strategies built in our research environment or bring your own via API — you choose the control level. The same decision-making code and microservice interactions run in both backtesting and live, so every backtest result is directly comparable to live performance. Monitor yesterday's trading for T+1 diffs between simulation and reality.",
    icon: Zap,
    pricing: "Contact us",
    ...
    bestFor:
      "Funds who want institutional-grade execution with provable alignment between backtest and live performance",
    cta: "Start Executing",
  },
  {
    id: "full",
    ...
    description:
      "The complete package. We provide the data, train the models, run the strategies, manage the risk, generate the reports, and handle the compliance. You allocate capital and review performance.",
    icon: Shield,
    pricing: "Contact us",
    ...
    bestFor:
      "Allocators, family offices, and institutions seeking managed alpha",
  ...
  },
  {
    ...
    bestFor:
      "Allocators, family offices, and professional investors seeking managed alpha with full regulatory protection and co-investment alignment",
    cta: "Schedule Consultation",
  },
  {
    id: "regulatory",
    ...
    description:
      "Become an FCA Appointed Representative under our principal firm. We provide the regulatory permissions, compliance supervision, and reporting infrastructure — you focus on trading. Ideal for institutional algo trading firms that need FCA coverage without the 12-month authorisation process.",
    icon: Scale,
    pricing: "Contact us",
    ...
    bestFor:
      "Algo trading firms and quant shops that need FCA permissions without building their own compliance function",
    cta: "Get in Touch",
  },
  {
    id: "custom",
    ...
    bestFor:
      "Institutions with specific operational requirements, or anyone whose needs don't fit neatly into a standard tier",
    cta: "Get in Touch",
  },
];
...
const JOURNEY_STEPS = [
  {
    ...
    label: "Access Data",
    description:
      "Connect to 128 venues across all asset classes, real-time and historical",
    icon: Database,
    color: "text-blue-400",
  },
  {
    ...
    label: "Train Models",
    description:
      "ML model training — predict direction, volatility, regime, momentum",
    icon: Brain,
    color: "text-purple-400",
  },
  {
    step: "3",
    label: "Build Signals & Algos",
    description:
      "Configure signal-to-trade rules and select execution algorithms — simple algos included, complex ones as a bolt-on",
    icon: FlaskConical,
  ...
  },
  {
    ...
    description:
      "Backtest across years of data, compare variants, validate edge before going live",
    icon: BarChart3,
    color: "text-cyan-400",
  },
  {
    ...
    label: "Execute Live",
    description:
      "Deploy from research or via API — same code runs backtest and live, so you can monitor T+1 diffs between simulation and reality",
    icon: Zap,
  ...
  },
  {
    ...
    description: "P&L attribution, risk oversight, settlement, compliance",
    icon: FileText,
        ...
        <div className="container px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Start with data access. Add research and backtesting. Scale to
              live execution. Or let us manage everything. You choose the depth.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="mt-6 text-center">
            <p className="text-xs text-muted-foreground">
              Each tier includes everything before it. Start anywhere, expand
              when ready.
            </p>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {ENGAGEMENT_TIERS.map((tier) => {
              ...
              return (
                <Card
                  key={tier.id}
                  className={`relative flex flex-col ${tier.color}`}
                >
                  {tier.popular && (
                      ...
                      <div className="flex gap-2">
                        {tier.serviceUrl && (
                          <Button
                            ...
                            asChild
                          >
                            <Link href={tier.serviceUrl}>Learn More</Link>
                          </Button>
                        )}
                        <Button
                          className="flex-1"
                        ...
                        >
                          <Link
                            href={`/contact?service=${tier.id}&action=demo`}
                          >
                            {tier.cta}
        ...
        <div className="container px-4 md:px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Every capability is independent. You don&apos;t have to buy a
              &ldquo;tier&rdquo; — pick the capabilities you need and choose
              your level of control for each. Mix self-service, managed, and
              bring-your-own however you like.
            </p>
          </div>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <p className="text-center text-xs text-muted-foreground mt-8">
              Pricing is based on what you pick — not which &ldquo;tier&rdquo;
              you&apos;re on.{" "}
          ...
          <Card className="bg-primary text-primary-foreground">
            <CardContent className="py-12 text-center">
              ...
              <p className="text-primary-foreground/80 mb-8 max-w-2xl mx-auto">
                Most clients start with Data Access, add Research within 3
                months, and move to Execution within 6. We&apos;ll help you find
                the right path.
              </p>
