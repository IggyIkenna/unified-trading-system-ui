...
const ENGAGEMENT_TIERS = [
  {
    ...
    description: "Access our unified data layer — covering 33 venues across crypto, traditional finance, DeFi, sports betting, and prediction markets. One schema, one API, all the data you need. Because your data lives on the same infrastructure as our research and execution platform, upgrading to model training, backtesting, or live execution is instant — no data migration, no egress delays.",
    icon: Database,
    pricing: "From £250/mo",
