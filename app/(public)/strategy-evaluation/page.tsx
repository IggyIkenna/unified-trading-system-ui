      ...
      <form onSubmit={handleSubmit} noValidate className="space-y-0">
            ...
            <>
              ...
              {(form.planToRaiseExternalCapital === "yes" || form.planToRaiseExternalCapital === "exploring") && (
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">How do you plan to reach LPs? Select all that apply.</p>
                  <div className="flex flex-col gap-2">
                    {(
                      [
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-muted-foreground">
                  Target minimum ticket size and any flexibility notes. Odum does not impose a fixed minimum — this is a
                  commercial conversation based on your LP mix.
                </p>
                <Input
        ...
        <section className="space-y-4 pt-8 border-t border-border/40">
          ...
          <p className="text-xs text-muted-foreground border-l-2 border-border pl-3 py-1 mt-2">
            <span className="font-medium text-foreground">Distribution assistance:</span> If requested by the manager,
            Odum may engage in distribution assistance to help with fundraising, but not under contract and with no
            standing expectation unless separately agreed.
          </p>
        </section>
          ...
          <div className="space-y-3">
            ...
            <div>
              <label className="flex items-start gap-3 cursor-pointer text-sm">
                ...
                />
                <span>
                  I understand that, under <Term id="dart-signals-in">DART Signals-In</Term>, Odum may route or execute
                  signals that map into the agreed payload schema, and display those signals and their analytics solely
                  so that the client can use Odum&rsquo;s execution and post-trade software.
                  <RequiredMarker />
                </span>
              </label>
        ...
        <section className="space-y-4 pt-8 border-t border-border/40">
          ...
          <p className="text-xs text-muted-foreground -mt-2">
            Odum will conduct its own technical taxonomy mapping. Your selections here help us pre-route the evaluation
            to the right team and design the demo to your use case. Hover any term for a definition.
          </p>
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs text-muted-foreground">
              Optional — share any context on your current tech stack, how standalone the strategy is, or what level of
              integration you&rsquo;re expecting. Odum will map the taxonomy formally.
            </p>
            <Textarea
              rows={3}
          ...
          {form.hasBacktest !== "no" && form.hasBacktest !== "" && (
            <>
              ...
              <div className="space-y-1">
                ...
                <Input value={form.avgTradesPerDay} onChange={(e) => setField("avgTradesPerDay", e.target.value)} />
              </div>
        ...
        {form.hasBacktest !== "no" && form.hasBacktest !== "" && (
          <section className="space-y-4 pt-8 border-t border-border/40">
            ...
            <p className="text-xs text-muted-foreground -mt-2">
              ...
              them immediately to verify they&rsquo;re correct. Upload to Odum&rsquo;s regulated storage happens when
              you press <strong>Submit evaluation</strong>. On localhost nothing is uploaded; filename and size are
              recorded as a draft only.
            </p>
        ...
        <section className="space-y-4 pt-8 border-t border-border/40">
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs text-muted-foreground">
              Position sizing, concentration limits, drawdown controls, signal filters, leverage caps, and kill-switch
              logic built into the strategy decision layer.
            </p>
            <Textarea
              rows={4}
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs text-muted-foreground">
              ...
              exposure caps, or circuit breakers applied at the execution layer (separate from the strategy&rsquo;s own
              logic).
            </p>
            <Textarea
              rows={4}
        ...
        <section className="space-y-4 pt-8 border-t border-border/40">
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs text-muted-foreground">
              Does the strategy require active management of idle capital across venues or chains? Stablecoin sweeps,
              collateral optimisation, cross-venue transfer flows?
            </p>
            <Textarea
              rows={3}
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs text-muted-foreground">
              Are instant or same-day deposits and withdrawals required? Any constraints on settlement timing, lock-up
              periods, or liquidity buffers?
            </p>
            <Textarea
              rows={3}
          ...
          <section className="space-y-4 pt-8 border-t border-border/40">
            ...
            <div className="rounded-lg border border-border/60 bg-muted/30 p-4 text-sm space-y-2 text-muted-foreground">
              ...
              <ul className="list-disc list-inside space-y-1 text-xs">
                ...
                <li>
                  Full <Term id="tca">TCA</Term> suite — slippage analysis, fill quality benchmarking, venue comparison
                </li>
                <li>
              ...
              <p className="text-xs">
                The questions below help us understand how your signals arrive and what execution and analytics surfaces
                will be most relevant to your use case.
              </p>
            </div>
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-muted-foreground">
                Can signals map into the agreed payload schema? Describe how signals are generated and delivered — batch
                file, webhook push, REST pull, or other — and the expected latency from decision to delivery.
              </p>
              <Textarea
                rows={4}
        ...
        {form.commercialPath === "C" && (
          <section className="space-y-4 pt-8 border-t border-border/40">
            ...
            <p className="text-sm text-muted-foreground">
              The <Term id="regulatory-umbrella">Regulatory Umbrella</Term> is cross-cutting and does not prescribe a
              specific API key or entity setup. The questions below help us understand the operational arrangement so we
              can configure oversight and reporting appropriately.
            </p>
        ...
        <section className="space-y-4 pt-8 border-t border-border/40">
          ...
          <div className="space-y-2 rounded-md border border-border/60 bg-card/40 px-4 py-3">
            ...
            {form.hasLiveTraded === "no" && (
              <p className="text-xs text-muted-foreground italic">
                No live track record yet — that&rsquo;s expected for many submissions. DART Full includes the live-tiny
                to live-allocated progression as part of incubation.
              </p>
            )}
          </div>
        ...
        <div className="pt-8 border-t border-border/40">
          ...
          {uploadStatus && <p className="text-xs text-muted-foreground mt-2">{uploadStatus}</p>}
