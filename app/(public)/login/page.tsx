...
import { Sparkles, ArrowRight, Mail, Lock, Shield, Users, Eye } from "lucide-react"
...
export default function LoginPage() {
  ...
  React.useEffect(() => {
    if (personaParam && !loading && !user) {
      login(personaParam).then((success) => {
        if (success) {
            ...
            <CardHeader className="text-center">
              ...
              {!isFirebaseMode && (
                <div className="flex items-center justify-center gap-1 mt-4 p-1 rounded-lg bg-muted/50">
                  ...
                  >
                    <div>Internal</div>
                    <div className="text-[9px] font-normal text-muted-foreground mt-0.5">Odum team</div>
                  </button>
                  <button
                  ...
                  >
                    ...
                    <div className="text-[9px] font-normal text-muted-foreground mt-0.5">Subscribed services</div>
                  </button>
                </div>
              )}
            </CardHeader>
