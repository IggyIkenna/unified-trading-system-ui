    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative border-b border-border">
        <div className="container px-4 py-16 md:px-6">
          ...
          {/* Parallel rails over lifecycle spine with stage nodes */}
          <div className="max-w-5xl mx-auto">
            {/* Lifecycle stage headers */}
            <div className="grid grid-cols-8 gap-2 mb-6 px-1">
              <div className="col-span-1" />
              {["Acquire", "Build", "Promote", "Run", "Observe", "Manage", "Report"].map((stage) => (
                <div key={stage} className="text-center">
                  <span className="text-[10px] md:text-xs text-muted-foreground font-medium">{stage}</span>
                </div>
              ))}
            </div>

            {/* Lane rails with stage nodes */}
            <div className="space-y-4">
              {/* Data lane - Acquire, Build, Observe emphasized */}
              <div className="grid grid-cols-8 gap-2 items-center group">
                <div className="flex flex-col">
                  <span className="text-xs font-semibold text-sky-400">Data</span>
                  <span className="text-[9px] text-muted-foreground hidden md:block">Feeds, normalisation, entitlements</span>
                </div>
                <div className="flex items-center justify-center"><div className="size-3 rounded-full bg-sky-400 shadow-[0_0_8px_rgba(56,189,248,0.5)]" /></div>
                <div className="flex items-center justify-center"><div className="size-3 rounded-full bg-sky-400 shadow-[0_0_8px_rgba(56,189,248,0.5)]" /></div>
                <div className="flex items-center justify-center"><div className="size-1.5 rounded-full bg-sky-400/30" /></div>
                <div className="flex items-center justify-center"><div className="size-1.5 rounded-full bg-sky-400/30" /></div>
                <div className="flex items-center justify-center"><div className="size-3 rounded-full bg-sky-400 shadow-[0_0_8px_rgba(56,189,248,0.5)]" /></div>
                <div className="flex items-center justify-center"><div className="size-1.5 rounded-full bg-sky-400/20" /></div>
                <div className="flex items-center justify-center"><div className="size-1.5 rounded-full bg-sky-400/30" /></div>
                {/* Connecting rail line */}
                <div className="col-span-8 -mt-3 grid grid-cols-8 gap-2 px-1">
                  <div />
                  <div className="h-px bg-gradient-to-r from-sky-400/60 to-sky-400/60" />
                  <div className="h-px bg-sky-400/40" />
                  <div className="h-px bg-sky-400/20" />
                  <div className="h-px bg-sky-400/20" />
                  <div className="h-px bg-sky-400/40" />
                  <div className="h-px bg-sky-400/20" />
                  <div />
              ...
              {/* ML lane - Build, Promote, Run, Observe emphasized */}
              <div className="grid grid-cols-8 gap-2 items-center group">
                <div className="flex flex-col">
                  <span className="text-xs font-semibold text-violet-400">ML</span>
                  <span className="text-[9px] text-muted-foreground hidden md:block">Features, models, signals, inference</span>
                </div>
                <div className="flex items-center justify-center"><div className="size-1.5 rounded-full bg-violet-400/30" /></div>
                <div className="flex items-center justify-center"><div className="size-3 rounded-full bg-violet-400 shadow-[0_0_8px_rgba(167,139,250,0.5)]" /></div>
                <div className="flex items-center justify-center"><div className="size-3 rounded-full bg-violet-400 shadow-[0_0_8px_rgba(167,139,250,0.5)]" /></div>
                <div className="flex items-center justify-center"><div className="size-3 rounded-full bg-violet-400 shadow-[0_0_8px_rgba(167,139,250,0.5)]" /></div>
                <div className="flex items-center justify-center"><div className="size-3 rounded-full bg-violet-400 shadow-[0_0_8px_rgba(167,139,250,0.5)]" /></div>
                <div className="flex items-center justify-center"><div className="size-1.5 rounded-full bg-violet-400/20" /></div>
                <div className="flex items-center justify-center"><div className="size-1.5 rounded-full bg-violet-400/20" /></div>
                <div className="col-span-8 -mt-3 grid grid-cols-8 gap-2 px-1">
                  <div />
                  <div className="h-px bg-violet-400/20" />
                  <div className="h-px bg-gradient-to-r from-violet-400/60 to-violet-400/60" />
                  <div className="h-px bg-violet-400/60" />
                  <div className="h-px bg-violet-400/60" />
                  <div className="h-px bg-violet-400/40" />
                  <div className="h-px bg-violet-400/20" />
                  <div />
                </div>
              </div>

              {/* Strategy lane - Build, Promote, Run, Observe emphasized */}
              <div className="grid grid-cols-8 gap-2 items-center group">
                <div className="flex flex-col">
                  <span className="text-xs font-semibold text-amber-400">Strategy</span>
                  <span className="text-[9px] text-muted-foreground hidden md:block">Research, simulation, decision logic</span>
                </div>
                <div className="flex items-center justify-center"><div className="size-1.5 rounded-full bg-amber-400/20" /></div>
                <div className="flex items-center justify-center"><div className="size-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.5)]" /></div>
                <div className="flex items-center justify-center"><div className="size-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.5)]" /></div>
                <div className="flex items-center justify-center"><div className="size-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.5)]" /></div>
                <div className="flex items-center justify-center"><div className="size-3 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.5)]" /></div>
                <div className="flex items-center justify-center"><div className="size-1.5 rounded-full bg-amber-400/20" /></div>
                <div className="flex items-center justify-center"><div className="size-1.5 rounded-full bg-amber-400/30" /></div>
                <div className="col-span-8 -mt-3 grid grid-cols-8 gap-2 px-1">
                  <div />
                  <div className="h-px bg-amber-400/20" />
                  <div className="h-px bg-gradient-to-r from-amber-400/60 to-amber-400/60" />
              ...
              {/* Execution lane - Promote, Run, Observe emphasized */}
              <div className="grid grid-cols-8 gap-2 items-center group">
                <div className="flex flex-col">
                  <span className="text-xs font-semibold text-emerald-400">Execution</span>
                  <span className="text-[9px] text-muted-foreground hidden md:block">Algos, routing, transaction cost</span>
                </div>
                <div className="flex items-center justify-center"><div className="size-1.5 rounded-full bg-emerald-400/20" /></div>
                <div className="flex items-center justify-center"><div className="size-1.5 rounded-full bg-emerald-400/30" /></div>
                <div className="flex items-center justify-center"><div className="size-3 rounded-full bg-emerald-400 shadow-[0_0_8px_rgba(52,211,153,0.5)]" /></div>
                <div className="flex items-center justify-center"><div className="size-3 rounded-full bg-emerald-400 shadow-[0_0_8px_rgba(52,211,153,0.5)]" /></div>
                <div className="flex items-center justify-center"><div className="size-3 rounded-full bg-emerald-400 shadow-[0_0_8px_rgba(52,211,153,0.5)]" /></div>
                <div className="flex items-center justify-center"><div className="size-1.5 rounded-full bg-emerald-400/20" /></div>
                <div className="flex items-center justify-center"><div className="size-1.5 rounded-full bg-emerald-400/30" /></div>
                <div className="col-span-8 -mt-3 grid grid-cols-8 gap-2 px-1">
                  ...
                  <div className="h-px bg-gradient-to-r from-emerald-400/60 to-emerald-400/60" />
                  <div className="h-px bg-emerald-400/60" />
                  <div className="h-px bg-emerald-400/40" />
                  <div className="h-px bg-emerald-400/20" />
                  <div />
                </div>
              </div>

              {/* Capital lane - Manage, Report emphasized */}
              <div className="grid grid-cols-8 gap-2 items-center group">
                <div className="flex flex-col">
                  <span className="text-xs font-semibold text-rose-400">Capital</span>
                  <span className="text-[9px] text-muted-foreground hidden md:block">Mandates, allocations, oversight</span>
                </div>
                <div className="flex items-center justify-center"><div className="size-1.5 rounded-full bg-rose-400/20" /></div>
                <div className="flex items-center justify-center"><div className="size-1.5 rounded-full bg-rose-400/20" /></div>
                <div className="flex items-center justify-center"><div className="size-1.5 rounded-full bg-rose-400/30" /></div>
                <div className="flex items-center justify-center"><div className="size-2 rounded-full bg-rose-400/50" /></div>
                <div className="flex items-center justify-center"><div className="size-2 rounded-full bg-rose-400/50" /></div>
                <div className="flex items-center justify-center"><div className="size-3 rounded-full bg-rose-400 shadow-[0_0_8px_rgba(251,113,133,0.5)]" /></div>
                <div className="flex items-center justify-center"><div className="size-3 rounded-full bg-rose-400 shadow-[0_0_8px_rgba(251,113,133,0.5)]" /></div>
                <div className="col-span-8 -mt-3 grid grid-cols-8 gap-2 px-1">
                  <div />
                  <div className="h-px bg-rose-400/20" />
                  <div className="h-px bg-rose-400/20" />
                  <div className="h-px bg-rose-400/30" />
                  <div className="h-px bg-rose-400/40" />
                  <div className="h-px bg-rose-400/50" />
                  <div className="h-px bg-gradient-to-r from-rose-400/60 to-rose-400/60" />
                  <div />
                </div>
              </div>

              {/* Compliance lane - Promote, Run, Observe, Report emphasized */}
              <div className="grid grid-cols-8 gap-2 items-center group">
                <div className="flex flex-col">
                  <span className="text-xs font-semibold text-slate-400">Compliance</span>
                  <span className="text-[9px] text-muted-foreground hidden md:block">Audit trail, regulatory controls, reporting</span>
                </div>
                <div className="flex items-center justify-center"><div className="size-1.5 rounded-full bg-slate-400/20" /></div>
                <div className="flex items-center justify-center"><div className="size-1.5 rounded-full bg-slate-400/30" /></div>
                <div className="flex items-center justify-center"><div className="size-2.5 rounded-full bg-slate-400/80" /></div>
                <div className="flex items-center justify-center"><div className="size-2.5 rounded-full bg-slate-400/80" /></div>
                <div className="flex items-center justify-center"><div className="size-2.5 rounded-full bg-slate-400/80" /></div>
                <div className="flex items-center justify-center"><div className="size-2 rounded-full bg-slate-400/60" /></div>
                <div className="flex items-center justify-center"><div className="size-3 rounded-full bg-slate-400 shadow-[0_0_8px_rgba(148,163,184,0.5)]" /></div>
                <div className="col-span-8 -mt-3 grid grid-cols-8 gap-2 px-1">
                  <div />
                  <div className="h-px bg-slate-400/20" />
            ...
            <div className="flex justify-center items-center gap-6 md:gap-10 mt-8 text-[10px] text-muted-foreground border-t border-border/50 pt-6">
              <div className="flex items-center gap-2">
                <div className="size-3 rounded-full bg-emerald-400 shadow-[0_0_8px_rgba(52,211,153,0.5)]" />
