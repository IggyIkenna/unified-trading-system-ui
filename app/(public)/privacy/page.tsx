      ...
      <main className="container px-4 py-16 max-w-3xl">
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-muted-foreground">
          ...
          <section>
            ...
            <p>
              We collect information you provide directly, including name, email, company details, and trading
              preferences when you create an account or contact us.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              security audits. As an FCA-authorised firm, we adhere to strict data protection requirements.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              We retain data as required by regulatory obligations and for legitimate business purposes. Trading data is
              retained for a minimum of 5 years per MiFID II requirements.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Under GDPR, you have rights to access, correct, delete, and port your data. Contact{" "}
              <a href="mailto:info@odum-research.com" className="text-primary hover:underline">
          ...
          <section>
            ...
            <p>Data Protection Officer: Odum Research Ltd, 9 Appold Street, London, EC2A 2AP, UK</p>
          </section>
        </div>
      </main>
    </div>
