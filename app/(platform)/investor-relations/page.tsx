...
const PRESENTATIONS: readonly IrDeckPresentation[] = [
  {
    ...
    description:
      "15-slide strategic advisor deck: how we got here → the landscape (named competitors) → the Odum solution → IP-protection proof → traction → demand evidence → trajectory → the ask → live demo.",
