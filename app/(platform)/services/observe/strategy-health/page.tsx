  ...
  const filtered = React.useMemo(() => {
    ...
    result = [...result].sort((a, b) => {
      ...
      switch (key) {
        ...
        case "pnl":
          aVal = a.pnlToday; bVal = b.pnlToday; break
        case "drawdown":
          aVal = a.drawdownPct; bVal = b.drawdownPct; break
        default:
...
function StrategyCard({ strategy }: { strategy: StrategyHealth }) {
  const drawdownRatio = strategy.maxDrawdownPct > 0
      ...
      <CardContent className="p-4 space-y-4">
        ...
        <div className="flex items-center justify-between text-xs border-t border-border pt-3">
          <div>
            ...
            <span className="font-mono font-medium">{strategy.sharpeRatio.toFixed(1)}</span>
          </div>
          <div>
