...
const SERVICE_SECTIONS: Record<string, Array<{
  ...
  "data-catalogue": [
    ...
    { label: "Service Health", href: "/services/observe/health", description: "Pipeline freshness and SLA monitoring" },
  ],
  markets: [
  ...
  admin: [
    ...
    { label: "User Management", href: "/services/manage/users", description: "Invite, roles, permissions" },
    { label: "Client Management", href: "/services/manage/clients", description: "Org subscriptions, API keys" },
    { label: "Fee Management", href: "/services/manage/fees", description: "Fee schedules and simulation" },
  ],
  ops: [
    { label: "Operations", href: "/ops", description: "Batch jobs, service health, event stream" },
    { label: "System Health", href: "/services/observe/health", description: "Service status and feature freshness" },
  ],
  deployment: [
    { label: "DevOps Dashboard", href: "/devops", description: "Deployments, builds, rollbacks" },
  ],
  compliance: [
    { label: "Compliance", href: "/services/manage/compliance", description: "FCA registration, regulatory info" },
  ],
  manage: [
    { label: "User Management", href: "/services/manage/users", description: "Users, roles, invitations" },
    { label: "Client Management", href: "/services/manage/clients", description: "Organizations, subscriptions" },
    { label: "Fee Management", href: "/services/manage/fees", description: "Fee schedules, simulation" },
    { label: "Mandate Management", href: "/services/manage/mandates", description: "Investment mandates, guidelines" },
  ],
}
            ...
            <div className="mt-6 flex items-center gap-4 rounded-lg border border-border/50 bg-card/50 p-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-muted-foreground">
                  ...
                  {" "}
                  <Link href="/services/overview" className="text-primary hover:underline">Manage subscription</Link>
                </p>
              </div>
            </div>
          )}
