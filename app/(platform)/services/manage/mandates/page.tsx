...
import {
  FileText, Target, AlertTriangle, ClipboardCheck,
...
interface MandateDetail {
  ...
  feeStructure: { managementFee: number; performanceFee: number; hurdleRate: number }
}
...
const FALLBACK_MANDATES: Mandate[] = [
  {
    id: "MND-001", client: "Apex Capital", strategy: "Global Macro", assetClass: "Equities",
    allocationTarget: 40, currentAllocation: 38.2, drift: -1.8, maxDrawdownLimit: 15, status: "active",
    lastReviewed: "2026-03-18",
    detail: {
      allocationLimits: { Equities: { min: 30, max: 50 }, Bonds: { min: 20, max: 40 }, Commodities: { min: 5, max: 15 }, Cash: { min: 5, max: 20 } },
  ...
  {
    id: "MND-002", client: "Meridian Fund", strategy: "Stat Arb", assetClass: "Equities",
    allocationTarget: 60, currentAllocation: 64.1, drift: 4.1, maxDrawdownLimit: 10, status: "breached",
    lastReviewed: "2026-03-20",
    detail: {
      allocationLimits: { Equities: { min: 50, max: 65 }, Derivatives: { min: 10, max: 30 }, Cash: { min: 5, max: 20 } },
  ...
  {
    id: "MND-003", client: "Sterling Partners", strategy: "Fixed Income", assetClass: "Bonds",
    allocationTarget: 70, currentAllocation: 69.5, drift: -0.5, maxDrawdownLimit: 8, status: "active",
    lastReviewed: "2026-03-15",
    detail: {
      allocationLimits: { Bonds: { min: 60, max: 80 }, Cash: { min: 10, max: 30 }, Equities: { min: 0, max: 10 } },
  ...
  {
    id: "MND-004", client: "Vanguard Wealth", strategy: "Multi-Asset", assetClass: "Multi-Asset",
    allocationTarget: 50, currentAllocation: 48.7, drift: -1.3, maxDrawdownLimit: 12, status: "active",
    lastReviewed: "2026-03-19",
    detail: {
      allocationLimits: { Equities: { min: 25, max: 45 }, Bonds: { min: 25, max: 45 }, Alternatives: { min: 5, max: 20 }, Cash: { min: 5, max: 15 } },
  ...
  {
    id: "MND-005", client: "Apex Capital", strategy: "Momentum", assetClass: "Commodities",
    allocationTarget: 15, currentAllocation: 17.8, drift: 2.8, maxDrawdownLimit: 20, status: "under-review",
    lastReviewed: "2026-03-21",
    detail: {
      allocationLimits: { Commodities: { min: 10, max: 20 }, Equities: { min: 0, max: 10 }, Cash: { min: 5, max: 15 } },
  ...
  {
    id: "MND-006", client: "Meridian Fund", strategy: "Long/Short Equity", assetClass: "Equities",
    allocationTarget: 35, currentAllocation: 34.2, drift: -0.8, maxDrawdownLimit: 18, status: "active",
    lastReviewed: "2026-03-17",
    detail: {
      allocationLimits: { Equities: { min: 25, max: 45 }, Derivatives: { min: 15, max: 35 }, Cash: { min: 5, max: 20 } },
  ...
  {
    id: "MND-007", client: "Pinnacle Investments", strategy: "Credit", assetClass: "Bonds",
    allocationTarget: 55, currentAllocation: 58.3, drift: 3.3, maxDrawdownLimit: 10, status: "breached",
    lastReviewed: "2026-03-22",
    detail: {
      allocationLimits: { Bonds: { min: 45, max: 55 }, Cash: { min: 10, max: 25 }, Equities: { min: 0, max: 10 } },
  ...
  {
    id: "MND-008", client: "Sterling Partners", strategy: "Relative Value", assetClass: "Derivatives",
    allocationTarget: 25, currentAllocation: 24.1, drift: -0.9, maxDrawdownLimit: 14, status: "active",
    lastReviewed: "2026-03-16",
    detail: {
      allocationLimits: { Derivatives: { min: 15, max: 30 }, Equities: { min: 10, max: 25 }, Bonds: { min: 10, max: 25 }, Cash: { min: 5, max: 15 } },
  ...
  {
    id: "MND-009", client: "Vanguard Wealth", strategy: "DeFi Yield", assetClass: "Digital Assets",
    allocationTarget: 10, currentAllocation: 12.4, drift: 2.4, maxDrawdownLimit: 25, status: "under-review",
    lastReviewed: "2026-03-20",
    detail: {
      allocationLimits: { "Digital Assets": { min: 5, max: 15 }, Cash: { min: 20, max: 40 }, Equities: { min: 10, max: 30 } },
  ...
  {
    id: "MND-010", client: "Pinnacle Investments", strategy: "Global Macro", assetClass: "Multi-Asset",
    allocationTarget: 45, currentAllocation: 44.6, drift: -0.4, maxDrawdownLimit: 16, status: "active",
    lastReviewed: "2026-03-19",
    detail: {
      allocationLimits: { Equities: { min: 20, max: 40 }, Bonds: { min: 15, max: 35 }, Commodities: { min: 5, max: 20 }, Cash: { min: 5, max: 15 } },
      positionLimits: { maxSinglePosition: 5, maxSectorExposure: 25 },
...
function mandateColumns(
  ...
  return [
    ...
    },
    {
      ...
      header: "Target %",
      cell: ({ getValue }) => (
        <span className="text-right font-mono block">{getValue<number>().toFixed(1)}</span>
      ),
    },
    {
    ...
    },
    {
      ...
      header: "Max DD Limit",
      cell: ({ getValue }) => (
        <span className="text-right font-mono block">{getValue<number>()}%</span>
      ),
    },
    {
      accessorKey: "status",
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <ExportDropdown
          ...
          columns={[
            ...
            { key: "allocationTarget", header: "Target %", format: (v: unknown) => Number(v).toFixed(1) },
            { key: "currentAllocation", header: "Current %", format: (v: unknown) => Number(v).toFixed(1) },
            { key: "drift", header: "Drift", format: (v: unknown) => (Number(v) > 0 ? "+" : "") + Number(v).toFixed(1) },
            { key: "maxDrawdownLimit", header: "Max DD Limit", format: (v: unknown) => `${Number(v)}%` },
