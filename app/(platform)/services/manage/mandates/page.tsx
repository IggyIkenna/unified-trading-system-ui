      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <ExportDropdown
          ...
          columns={[
            ...
            { key: "allocationTarget", header: "Target %", format: (v: number) => v.toFixed(1) },
            { key: "currentAllocation", header: "Current %", format: (v: number) => v.toFixed(1) },
            { key: "drift", header: "Drift", format: (v: number) => (v > 0 ? "+" : "") + v.toFixed(1) },
            { key: "maxDrawdownLimit", header: "Max DD Limit", format: (v: number) => `${v}%` },
