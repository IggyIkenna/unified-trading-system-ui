...
const ENTITLEMENTS = [
  ...
  { key: "data-pro", label: "Data (Pro) — 2400+ instruments, CeFi + TradFi + DeFi" },
  { key: "execution-basic", label: "Execution (Basic) — TWAP, VWAP algos" },
  { key: "execution-full", label: "Execution (Full) — All algos + SOR + dark pools" },
  { key: "ml-full", label: "ML & Backtesting — Model training & deployment" },
  { key: "strategy-full", label: "Strategy Platform — Backtesting & strategy deployment" },
  { key: "reporting", label: "Reporting & Analytics — P&L, settlement, compliance" },
]
  ...
  return (
    <div className="p-6 max-w-2xl space-y-6">
      ...
      <p className="text-muted-foreground">
        Select the services you need access to. Your request will be reviewed by an admin.
      </p>
