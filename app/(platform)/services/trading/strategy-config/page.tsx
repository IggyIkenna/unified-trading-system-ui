...
export default function StrategyConfigPage() {
  ...
  const canAccess = isAdmin() || isInternal() || (hasEntitlement("strategy-full") && hasEntitlement("ml-full"));
      ...
      <div className="p-6">
        <Card className="border-amber-500/30 bg-amber-500/5">
          <CardHeader>
            ...
            <CardDescription>
              Strategy configuration requires both Strategy-Full and ML-Full entitlements. DART Signals-In clients bring
              their own signals and do not configure Odum strategies: see the Signal Intake tab.
            </CardDescription>
          </CardHeader>
          <CardContent>
  ...
  return (
    <div className="p-6 space-y-4">
      <PageHeader
        ...
        description={
          <span>
            Configure confirmers, ML, execution-backtest, and strategy parameters for a live strategy. Param edits
            trigger the version-bump modal: see{" "}
            <Link
        ...
        <TabsContent value="confirmers" className="space-y-3">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Sanity checks that must pass before any strategy-generated order reaches the execution layer.
              </CardDescription>
            </CardHeader>
            <CardContent className="text-sm text-muted-foreground">
              Confirmer registry read API wiring pending: see admin truthiness follow-up.
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="ml" className="space-y-3">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Select the ML model for this strategy, retrain schedule, and subscribed feature groups. Feature
                subscriptions are read-only: managed centrally in admin.
              </CardDescription>
            </CardHeader>
            <CardContent className="text-sm text-muted-foreground">
        ...
        <TabsContent value="backtest" className="space-y-3">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Matching-engine simulation config: slippage model, commission model, latency model, venue liquidity.
                Used to measure execution alpha vs live fills.
              </CardDescription>
            </CardHeader>
            <CardContent className="text-sm text-muted-foreground">
        ...
        <TabsContent value="params" className="space-y-3">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Editing a live parameter opens the version-bump modal. Recommended path: bump the strategy version.
                Emergency hot-reload requires typing <code>I-ACCEPT-PARITY-BREAK</code> to confirm.
              </CardDescription>
            </CardHeader>
            <CardContent className="flex flex-wrap gap-3">
              <Button size="sm" onClick={() => setBumpOpen(true)} data-testid="strategy-config-edit-params">
