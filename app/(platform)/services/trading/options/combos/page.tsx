...
const STRATEGY_TEMPLATES: Record<string, StrategyTemplate> = {
  "bull-call-spread": {
    ...
    legs: [
      { direction: "buy", optionType: "call", strike: 4200, expiry: "2026-04-18", qty: 1, premium: 128.50 },
      { direction: "sell", optionType: "call", strike: 4400, expiry: "2026-04-18", qty: 1, premium: 42.30 },
    ],
  },
  "bear-put-spread": {
    ...
    legs: [
      { direction: "buy", optionType: "put", strike: 4300, expiry: "2026-04-18", qty: 1, premium: 115.20 },
      { direction: "sell", optionType: "put", strike: 4100, expiry: "2026-04-18", qty: 1, premium: 38.60 },
    ],
  },
  straddle: {
    label: "Straddle",
    ...
    legs: [
      { direction: "buy", optionType: "call", strike: 4250, expiry: "2026-04-18", qty: 1, premium: 98.40 },
      { direction: "buy", optionType: "put", strike: 4250, expiry: "2026-04-18", qty: 1, premium: 92.10 },
    ],
  },
  strangle: {
    label: "Strangle",
    ...
    legs: [
      { direction: "buy", optionType: "call", strike: 4400, expiry: "2026-04-18", qty: 1, premium: 42.30 },
      { direction: "buy", optionType: "put", strike: 4100, expiry: "2026-04-18", qty: 1, premium: 38.60 },
    ],
  },
  "iron-condor": {
    label: "Iron Condor",
    ...
    legs: [
      { direction: "buy", optionType: "put", strike: 4000, expiry: "2026-04-18", qty: 1, premium: 18.20 },
      { direction: "sell", optionType: "put", strike: 4100, expiry: "2026-04-18", qty: 1, premium: 38.60 },
      { direction: "sell", optionType: "call", strike: 4400, expiry: "2026-04-18", qty: 1, premium: 42.30 },
      { direction: "buy", optionType: "call", strike: 4500, expiry: "2026-04-18", qty: 1, premium: 16.80 },
    ],
  },
  butterfly: {
    label: "Butterfly",
    ...
    legs: [
      { direction: "buy", optionType: "call", strike: 4150, expiry: "2026-04-18", qty: 1, premium: 158.30 },
      { direction: "sell", optionType: "call", strike: 4250, expiry: "2026-04-18", qty: 2, premium: 98.40 },
      { direction: "buy", optionType: "call", strike: 4350, expiry: "2026-04-18", qty: 1, premium: 56.80 },
    ],
  },
  "calendar-spread": {
    ...
    legs: [
      { direction: "sell", optionType: "call", strike: 4250, expiry: "2026-04-18", qty: 1, premium: 98.40 },
      { direction: "buy", optionType: "call", strike: 4250, expiry: "2026-05-16", qty: 1, premium: 142.70 },
    ],
  },
  custom: {
    label: "Custom",
        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-0.5">
              Build multi-leg options strategies with real-time payoff analysis
            </p>
          </div>
          <div className="flex items-center gap-2">
            <span className="text-xs text-muted-foreground">Underlying:</span>
            <Badge variant="outline" className="font-mono">
              SPX {UNDERLYING_PRICE.toFixed(2)}
            </Badge>
          </div>
        </div>
      </div>
                  ...
                  {legs.map((leg, idx) => (
                    <TableRow key={leg.id}>
                      ...
                      <TableCell>
                        <Select
                          value={leg.direction}
                          onValueChange={(v) => updateLeg(leg.id, "direction", v)}
                        >
                  ...
                  <div className="flex items-end gap-px h-[160px]">
                    {payoffGrid.map((point) => {
                      ...
                      const isCurrentPrice =
                        Math.abs(point.price - UNDERLYING_PRICE) < priceRange.step / 2;

                      return (
                        <div
                          key={point.price}
                          className="flex-1 flex flex-col items-stretch relative group"
                          title={`Price: ${point.price} | P&L: $${point.payoff.toFixed(2)}`}
                        >
                          {/* Zero line at center */}
                  ...
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span
                      className={cn(
                        ...
                        netPremium >= 0 ? "text-emerald-400" : "text-rose-400",
                      )}
                    >
                      {netPremium >= 0 ? "Credit" : "Debit"} ${Math.abs(netPremium).toFixed(2)}
                    </span>
                  </div>
