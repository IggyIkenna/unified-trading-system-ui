  ...
  return [
    {
      ...
      sharpe: 1.5 + r(1) * 1.5,
      return: 0.12 + r(2) * 0.1,
      drawdown: 0.02 + r(3) * 0.03,
      days: 45,
    },
    {
      regime: "Mean Revert",
      sharpe: 1.2 + r(4) * 1.0,
      return: 0.08 + r(5) * 0.08,
      drawdown: 0.03 + r(6) * 0.03,
      days: 38,
    },
    {
      regime: "Volatile",
      sharpe: 0.3 + r(7) * 0.8,
      return: 0.02 + r(8) * 0.06,
      drawdown: 0.06 + r(9) * 0.06,
      days: 22,
    },
    {
      regime: "Low Vol",
      sharpe: 1.0 + r(10) * 0.8,
      return: 0.05 + r(11) * 0.05,
      drawdown: 0.01 + r(12) * 0.02,
      days: 30,
    },
  ];
}
