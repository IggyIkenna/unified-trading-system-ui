  ...
  categories: [
    {
      ...
      checks: [
        {
          id: "backtest",
          name: "Backtest completed (6mo OOS)",
          status: "passed",
          detail: "Sharpe 2.58, +7.1% vs champion",
        },
        {
          id: "walkforward",
          name: "Walk-forward validation",
          status: "passed",
          detail: "5/5 windows passed",
        },
        {
          id: "statistical",
          name: "Statistical significance tests",
          status: "passed",
          detail: "4/5 tests significant at α=0.05",
        },
        {
          id: "regime",
          name: "Regime robustness check",
          status: "passed",
          detail: "Outperforms in all 5 regimes",
        },
        {
          id: "stress",
          name: "Stress test scenarios",
          status: "passed",
          detail: "Max DD -4.2% in crash scenario",
        },
      ],
    },
    {
      ...
      checks: [
        {
          id: "latency",
          name: "Inference latency < 50ms p99",
          status: "passed",
          detail: "32ms p99",
        },
        {
          id: "throughput",
          name: "Throughput > 1000 req/s",
          status: "passed",
          detail: "2,340 req/s",
        },
        {
          id: "memory",
          name: "Memory footprint < 2GB",
          status: "passed",
          detail: "1.2GB peak",
        },
        {
          id: "gpu",
          name: "GPU utilization optimal",
          status: "passed",
          detail: "68% avg, no throttling",
        },
        {
          id: "serialization",
          name: "Model serialization valid",
          status: "passed",
          detail: "ONNX v1.14",
        },
      ],
    },
    {
      ...
      checks: [
        {
          id: "features",
          name: "All features available in prod",
          status: "passed",
          detail: "12/12 features mapped",
        },
        {
          id: "schema",
          name: "Input schema validated",
          status: "passed",
          detail: "v2.1 compatible",
        },
        {
          id: "freshness",
          name: "Feature freshness SLAs met",
          status: "warning",
          detail: "oi_change_1h: 850ms (target 500ms)",
        },
        {
          id: "fallback",
          name: "Fallback values configured",
          status: "passed",
          detail: "All 12 features have defaults",
        },
        {
          id: "drift",
          name: "No feature drift detected",
          status: "passed",
          detail: "PSI < 0.1 for all features",
        },
      ],
    },
    {
      ...
      checks: [
        {
          id: "review",
          name: "Quant team review",
          status: "passed",
          detail: "Approved by J. Smith",
        },
        {
          id: "risk",
          name: "Risk team sign-off",
          status: "pending",
          detail: "Awaiting M. Johnson",
        },
        {
          id: "audit",
          name: "Audit trail complete",
          status: "passed",
          detail: "Full lineage captured",
        },
        {
          id: "docs",
          name: "Documentation updated",
          status: "passed",
          detail: "Model card v2.4",
        },
        {
          id: "rollback",
          name: "Rollback plan documented",
          status: "passed",
          detail: "Automated rollback ready",
        },
      ],
    },
    {
      ...
      checks: [
        {
          id: "capacity",
          name: "Serving capacity available",
          status: "passed",
          detail: "4x A100 allocated",
        },
        {
          id: "monitoring",
          name: "Monitoring dashboards ready",
          status: "passed",
          detail: "Grafana configured",
        },
        {
          id: "alerts",
          name: "Alert thresholds configured",
          status: "passed",
          detail: "12 alerts active",
        },
        {
          id: "canary",
          name: "Canary deployment configured",
          status: "passed",
          detail: "5% initial traffic",
        },
        {
          id: "circuit",
          name: "Circuit breaker configured",
          status: "passed",
          detail: "Error rate > 5% triggers",
        },
      ],
    },
  ],
...
const DEFAULT_RECENT_DEPLOYMENTS = [
  {
    modelId: "vol-forecast-v1.8.2",
    deployedAt: "2026-03-15 09:00",
    status: "success",
    duration: "4h 32m",
    promotedBy: "j.smith@odum.io",
  },
  {
    modelId: "liq-detect-v3.1.0",
    deployedAt: "2026-03-12 14:30",
    status: "rolled_back",
    duration: "1h 15m",
    promotedBy: "m.wong@odum.io",
    reason: "Latency regression",
  },
  {
    modelId: "funding-pred-v2.3.1",
    deployedAt: "2026-03-01 10:00",
    status: "success",
    duration: "6h 45m",
    promotedBy: "a.chen@odum.io",
  },
  {
    modelId: "spread-pred-v2.0.0",
    deployedAt: "2026-02-20 11:15",
    status: "success",
    duration: "3h 20m",
    promotedBy: "j.smith@odum.io",
  },
...
export default function DeployReadinessPage() {
  ...
  const deploymentChecklist =
    (rawData as any)?.data?.checklist ??
    (rawData as any)?.checklist ??
    DEFAULT_DEPLOYMENT_CHECKLIST;
  const deploymentStages: any[] =
    (rawData as any)?.data?.stages ??
    (rawData as any)?.stages ??
    DEFAULT_DEPLOYMENT_STAGES;
  const recentDeployments: any[] =
    (rawData as any)?.data?.recentDeployments ??
    (rawData as any)?.recentDeployments ??
    DEFAULT_RECENT_DEPLOYMENTS;
  ...
  const allChecks = deploymentChecklist.categories.flatMap(
    (c: { checks: { status: string }[] }) => c.checks,
  );
  ...
  const getCategoryStatusBadge = (status: string) => {
    switch (status) {
      case "passed":
        return <Badge className="bg-[var(--status-success)]">Passed</Badge>;
      case "warning":
        return (
      ...
      case "failed":
        return <Badge className="bg-[var(--status-error)]">Failed</Badge>;
      default:
        return null;
    }
  };
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Pre-deployment checklist and rollout configuration
                </p>
              </div>
            </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold">
                      Deployment Blocked: Pending Approvals
                    </p>
                    <p className="text-sm text-muted-foreground">
          ...
          <div className="col-span-2 space-y-4">
            <Card>
              ...
              <CardContent>
                <Accordion
                  type="multiple"
                  defaultValue={["validation", "governance"]}
                >
                  {deploymentChecklist.categories.map(
                    (category: {
                      id: string;
                      name: string;
                      status: string;
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Gradual deployment with automatic checkpoints
                </CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  {deploymentStages.map((stage, idx) => (
                    <div key={stage.id} className="flex items-center">
                      ...
                      >
                        ...
                        <Badge
                          variant={
                            stage.status === "ready" ? "default" : "outline"
                          }
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Run predictions without acting
                    </p>
                  </div>
                  <Switch
                    checked={deploymentConfig.shadowMode}
                    onCheckedChange={(v) =>
                      setDeploymentConfig((p) => ({ ...p, shadowMode: v }))
                    }
                  />
                </div>
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(v) =>
                      setDeploymentConfig((p) => ({ ...p, autoRollback: v }))
                    }
                  />
                </div>
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Alert #ml-deploys channel
                    </p>
                  </div>
                  <Switch
                    checked={deploymentConfig.notifySlack}
                    onCheckedChange={(v) =>
                      setDeploymentConfig((p) => ({ ...p, notifySlack: v }))
                    }
                  />
                </div>
                <div className="pt-2 border-t">
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      onChange={(e) =>
                        setDeploymentConfig((p) => ({
                          ...p,
                          canaryPercent: parseInt(e.target.value),
                        }))
                      }
                      className="flex-1"
                    />
