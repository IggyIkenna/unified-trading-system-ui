...
import {
  ...
  generateValidationCurves,
  StatusBadge,
} from "./components/experiment-id-helpers";
...
export default function ExperimentDetailPage() {
  ...
  const experiment: Experiment | undefined =
    (experimentData as any)?.data ?? (experimentData as any)?.experiment ?? undefined;
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-between py-2 border-b border-border/50">
                      ...
                      <code className="font-mono">
                        {experiment.trainingConfig.gpuType} x{experiment.trainingConfig.numGpus}
                      </code>
                    </div>
                    <div className="flex items-center justify-between py-2">
                      <span className="text-sm text-muted-foreground">Early Stopping</span>
                      <Badge variant="outline">
                        {experiment.trainingConfig.earlyStopping ? "Enabled" : "Disabled"}
                      </Badge>
                    </div>
                  </div>
                </CardContent>
