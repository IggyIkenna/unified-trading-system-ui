...
| **card-grid**      | Card layout (templates, status cards, portfolio)                  | none — candidate for base                   | 7     |
| **detail-panel**   | Master-detail / drill-down panel                                  | none — candidate for base                   | 8     |
| **control-bar**    | Toolbar / selector strip / filter controls                        | none — candidate for base                   | 6     |
...
| Widget ID            | Display Name    | Class        | Chart Lib          | File                                     | Description                                                                 |
| -------------------- | --------------- | ------------ | ------------------ | ---------------------------------------- | --------------------------------------------------------------------------- |
| `terminal-watchlist` | Watchlist       | inline-table | —                  | `terminal/terminal-watchlist-widget.tsx` | Instrument list grouped by category with search and one-click selection     |
...
| `order-entry`        | Order Entry     | form         | —                  | `terminal/order-entry-widget.tsx`        | Buy/sell order form with account picker, strategy linking, and validation   |
...
| Widget ID            | Display Name        | Class     | Chart Lib | File                                    | Description                                                                                                                          |
| -------------------- | ------------------- | --------- | --------- | --------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| `bundle-builder`     | Bundle Builder      | bespoke   | —         | `bundles/bundle-builder-widget.tsx`     | Template gallery (toggleable) + step editor + P&L KPI strip + sticky simulate/submit in one workflow (merged 2026-04-22; see § WU-2) |
...
| **5**    | `ControlBarWidget`                                 | control-bar    | 6             | scope-summary, book-hierarchy-bar, pnl-controls, markets-controls, options-control-bar, sports-live-scores                                                                                                                                                                                                                                                                                                                                    | Horizontal bar with selects/toggles/badges. Base handles responsive collapse, shared filter state.                        |
...
| **Bundles**           | `bundle-builder`            | ✅ in default preset               |
...
| **Terminal**          | `terminal-watchlist`        | ✅ in default preset               |
