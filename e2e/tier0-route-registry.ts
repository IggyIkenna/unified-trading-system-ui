...
export const INVESTOR_SUBPAGES: Tier0Route[] = [
  { path: '/investor-relations/board-presentation', name: 'IR Board Presentation' },
  { path: '/investor-relations/disaster-recovery', name: 'IR Disaster Recovery' },
]
...
export const ML_EXPERIMENT_DETAIL_PAGES: Tier0Route[] = [
  { path: '/services/research/ml/experiments/exp-456', name: 'ML Experiment Detail' },
]
...
export const STRATEGY_DETAIL_PAGES: Tier0Route[] = [
  { path: '/services/trading/strategies/DEFI_ETH_BASIS_SCE_1H', name: 'Strategy Detail (registry sample)' },
]
...
export const MANAGE_PAGES_EXTRA: Tier0Route[] = [
  { path: '/services/manage/users/request', name: 'Manage User Access Request' },
]
...
export const TIER0_REGISTRY_PATHS: string[] = ALL_TIER0_ROUTES.map((r) => r.path)
