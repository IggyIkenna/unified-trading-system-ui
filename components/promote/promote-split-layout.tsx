...
const SPLIT_H = "min-h-[min(70vh,520px)] lg:h-[calc(100vh-9.25rem)] lg:max-h-[calc(100vh-9.25rem)]";
  ...
  return (
    <PromoteListFiltersProvider>
      <div className="grid min-h-0 flex-1 grid-cols-1 content-start gap-5 lg:grid-cols-3 lg:items-stretch">
        ...
        <div className={cn("flex min-h-0 min-w-0 flex-col lg:col-span-2", SPLIT_H)}>
          <div className="sticky top-0 z-20 shrink-0">
            <PromoteLifecycleSubTabs />
          </div>
          <WidgetScroll className="min-h-0 flex-1" viewportClassName="overscroll-contain">
