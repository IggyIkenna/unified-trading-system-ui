...
export function ShardCatalogue({
  ...
  const [expandedCategories, setExpandedCategories] = React.useState<Set<DataCategory>>(
    new Set(["cefi"])
  )
                ...
                <CardContent className="pt-0 pb-2 px-0">
                  <div className="divide-y divide-border/50">
                    {venueList.map(venue => {
                      ...
                      const venueCompleteness = venueEntries.length > 0
                      ...
                      return (
                        <div key={venue}>
                              ...
                              {venueCompleteness !== null && (
                                <div className="flex items-center gap-2">
                                  <div className={cn(
                                    ...
                                    venueCompleteness >= 95 ? "bg-emerald-500" :
                                    venueCompleteness >= 80 ? "bg-yellow-500" : "bg-red-500"
                                  )} />
                          ...
                          {/* Instrument rows */}
                          {expandedVenues.has(venueKey) && venueEntries.map(entry => {
