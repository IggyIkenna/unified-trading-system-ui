...
export function CloudPricingSelector({
  ...
  const hasCrossCloudSurcharge = selectedMode === "download" &&
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <Cloud className={cn("size-4",
                    cloud === "gcp" ? "text-blue-400" :
                    cloud === "aws" ? "text-orange-400" : "text-sky-400"
                  )} />
              ...
              {cloud !== "both" && org.linkedCloudAccount?.startsWith(cloud) && (
                <Badge variant="secondary" className="mt-1 text-[10px]">Linked</Badge>
              )}
            </button>
          ))}
        </div>
      ...
      <div className="space-y-2">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          >
            ...
            {hasCrossCloudSurcharge && (
              <div className="text-xs text-amber-400">+ $0.08/GB cross-cloud</div>
            )}
