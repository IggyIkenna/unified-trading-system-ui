      ...
      {fixture.stats ? (
        <div className="flex flex-col gap-3">
          <div className="flex items-center justify-between text-sm font-bold">
            <span className="text-zinc-100 truncate pr-2">
              {fixture.home.name}
            </span>
            <span className="text-xs text-zinc-500 uppercase tracking-widest shrink-0">
              Match stats
            </span>
            <span className="text-zinc-100 truncate text-right pl-2">
              {fixture.away.name}
            </span>
          </div>
          <MatchStatsPanel
        ...
        <p className="text-base text-zinc-500 text-center py-10">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              {fixture.lineups.home.startingXI.map((p, i) => (
                <p
                  key={i}
                  className="text-sm text-zinc-300 py-1 border-b border-zinc-800/50 last:border-0"
                >
                  {p}
                </p>
              ))}
              <p className="text-xs text-zinc-500 uppercase tracking-wider mt-3 mb-1">
                Subs
              </p>
  ...
  return (
    <div className="flex flex-col gap-4 p-4 overflow-auto">
      ...
      <p className="text-sm text-zinc-500">
        {fixture.progressiveOdds.length} snapshots · 30s intervals · vertical
        lines = goals
      </p>
      ...
      <div className="flex items-center gap-2">
        ...
        <Button
          ...
          className={cn(
            ...
            playing ? "bg-zinc-700" : "bg-[#22d3ee] text-black",
          )}
...
export function FixtureDetailPanel({
  ...
  return (
    <div
      className={cn(
        "flex flex-col min-h-0 h-full bg-[#0a0a0b] border-zinc-800",
        className,
      )}
    >
        ...
        <div className="px-4 pt-4 pb-3">
          ...
          {fixture.score ? (
            ...
            <div className="flex items-center justify-between gap-2">
              ...
              <span className="text-sm text-zinc-600 font-bold shrink-0">
                vs
              </span>
              <p className="text-base font-bold text-zinc-100 truncate text-right">
                {fixture.away.name}
              </p>
            </div>
          )}
