    ...
    >
      <div className="mx-auto flex max-w-screen-2xl items-center gap-3 px-4 py-2 text-xs sm:text-sm">
        ...
        <p className="flex-1 leading-snug">
          You&rsquo;re on a live mirror of the Odum platform for demos and
          evaluation. Data is simulated and sign-in uses demo accounts;
          ...
          >
            Tell us how to improve it &rarr;
          </Link>
        </p>
        <button
          type="button"
