...
registerPresets("pnl", [
  {
    ...
    layouts: [
      ...
      { widgetId: "pnl-waterfall", instanceId: "pnl-waterfall-1", x: 0, y: 0, w: 12, h: 11 },
  ...
  },
  {
    ...
    isPreset: true,
    layouts: [
      { widgetId: "pnl-waterfall", instanceId: "pnl-waterfall-ts", x: 0, y: 0, w: 12, h: 11 },
  ...
  },
  {
    ...
    isPreset: true,
    layouts: [
      { widgetId: "pnl-waterfall", instanceId: "pnl-waterfall-full", x: 0, y: 0, w: 12, h: 11 },
