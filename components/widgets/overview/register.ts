...
registerPresets("overview", [
  {
    ...
    isPreset: true,
    layouts: [
      { widgetId: "scope-summary", instanceId: "scope-summary-1", x: 0, y: 0, w: 24, h: 2 },
      { widgetId: "pnl-chart", instanceId: "pnl-chart-1", x: 0, y: 2, w: 24, h: 4 },
      { widgetId: "kpi-strip", instanceId: "kpi-strip-1", x: 0, y: 6, w: 24, h: 2 },
      { widgetId: "strategy-table", instanceId: "strategy-table-1", x: 0, y: 8, w: 24, h: 4 },
      { widgetId: "pnl-attribution", instanceId: "pnl-attribution-1", x: 0, y: 12, w: 6, h: 3 },
      { widgetId: "alerts-preview", instanceId: "alerts-preview-1", x: 6, y: 12, w: 6, h: 3 },
      { widgetId: "recent-fills", instanceId: "recent-fills-1", x: 12, y: 12, w: 6, h: 3 },
      { widgetId: "health-grid", instanceId: "health-grid-1", x: 18, y: 12, w: 6, h: 3 },
    ],
  ...
  },
  {
    ...
    isPreset: true,
    layouts: [
      { widgetId: "scope-summary", instanceId: "scope-summary-full", x: 0, y: 0, w: 24, h: 2 },
      { widgetId: "kpi-strip", instanceId: "kpi-strip-full", x: 0, y: 2, w: 24, h: 2 },
      { widgetId: "pnl-chart", instanceId: "pnl-chart-full", x: 0, y: 4, w: 24, h: 4 },
      { widgetId: "strategy-table", instanceId: "strategy-table-full", x: 0, y: 8, w: 24, h: 4 },
      { widgetId: "pnl-attribution", instanceId: "pnl-attribution-full", x: 0, y: 12, w: 6, h: 3 },
      { widgetId: "alerts-preview", instanceId: "alerts-preview-full", x: 6, y: 12, w: 6, h: 3 },
      { widgetId: "recent-fills", instanceId: "recent-fills-full", x: 12, y: 12, w: 6, h: 3 },
      { widgetId: "health-grid", instanceId: "health-grid-full", x: 18, y: 12, w: 6, h: 3 },
    ],
    createdAt: "2026-01-01T00:00:00Z",
    updatedAt: "2026-01-01T00:00:00Z",
  },
