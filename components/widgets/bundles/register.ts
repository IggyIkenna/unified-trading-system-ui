...
registerPresets("bundles", [
  {
    ...
    isPreset: true,
    layouts: [
      { widgetId: "bundle-builder", instanceId: "bundle-builder-1", x: 0, y: 0, w: 12, h: 14 },
      { widgetId: "defi-atomic-bundle", instanceId: "defi-atomic-bundle-1", x: 0, y: 14, w: 12, h: 8 },
    ],
  ...
  },
  {
    ...
    isPreset: true,
    layouts: [
      { widgetId: "bundle-builder", instanceId: "bundle-builder-1", x: 0, y: 0, w: 12, h: 10 },
      { widgetId: "defi-atomic-bundle", instanceId: "defi-atomic-bundle-1", x: 0, y: 10, w: 12, h: 8 },
    ],
    createdAt: "2026-01-01T00:00:00Z",
    updatedAt: "2026-01-01T00:00:00Z",
  },
  {
    ...
    isPreset: true,
    layouts: [
      { widgetId: "bundle-builder", instanceId: "bundle-builder-full", x: 0, y: 0, w: 8, h: 16 },
      { widgetId: "defi-atomic-bundle", instanceId: "defi-atomic-bundle-full", x: 8, y: 0, w: 4, h: 16 },
    ],
    createdAt: "2026-01-01T00:00:00Z",
    updatedAt: "2026-01-01T00:00:00Z",
  },
