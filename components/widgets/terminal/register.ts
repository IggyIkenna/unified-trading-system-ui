...
registerPresets("terminal", [
  {
    ...
    isPreset: true,
    layouts: [
      { widgetId: "terminal-watchlist", instanceId: "terminal-watchlist-1", x: 0, y: 0, w: 6, h: 12 },
      { widgetId: "order-book", instanceId: "order-book-1", x: 6, y: 0, w: 4, h: 8 },
      { widgetId: "price-chart", instanceId: "price-chart-1", x: 10, y: 0, w: 8, h: 8 },
      { widgetId: "order-entry", instanceId: "order-entry-1", x: 18, y: 0, w: 6, h: 8 },
      { widgetId: "market-trades", instanceId: "market-trades-1", x: 6, y: 8, w: 8, h: 4 },
      { widgetId: "calendar-events", instanceId: "calendar-events-1", x: 14, y: 8, w: 10, h: 4 },
    ],
  ...
  },
  {
    ...
    isPreset: true,
    layouts: [
      { widgetId: "terminal-watchlist", instanceId: "terminal-watchlist-full", x: 0, y: 0, w: 6, h: 12 },
      { widgetId: "order-book", instanceId: "order-book-full", x: 6, y: 0, w: 4, h: 8 },
      { widgetId: "price-chart", instanceId: "price-chart-full", x: 10, y: 0, w: 8, h: 8 },
      { widgetId: "order-entry", instanceId: "order-entry-full", x: 18, y: 0, w: 6, h: 8 },
      { widgetId: "market-trades", instanceId: "market-trades-full", x: 6, y: 8, w: 8, h: 4 },
      { widgetId: "calendar-events", instanceId: "calendar-events-full", x: 14, y: 8, w: 10, h: 4 },
      { widgetId: "terminal-options", instanceId: "terminal-options-full", x: 0, y: 12, w: 16, h: 8 },
      { widgetId: "events-feed", instanceId: "events-feed-full", x: 0, y: 20, w: 12, h: 6 },
    ],
    createdAt: "2026-01-01T00:00:00Z",
    updatedAt: "2026-01-01T00:00:00Z",
  },
