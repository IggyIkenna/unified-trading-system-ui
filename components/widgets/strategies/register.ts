...
registerPresets("strategies", [
  ...
  },
  {
    ...
    layouts: [
      ...
      { widgetId: "lending-arb-dashboard", instanceId: "lending-arb-dashboard-full", x: 0, y: 19, w: 6, h: 6 },
      { widgetId: "liquidation-monitor", instanceId: "liquidation-monitor-full", x: 6, y: 19, w: 6, h: 6 },
      { widgetId: "commodity-regime", instanceId: "commodity-regime-full", x: 0, y: 25, w: 6, h: 6 },
      { widgetId: "strategies-grid-link", instanceId: "strategies-grid-link-full", x: 0, y: 31, w: 12, h: 1 },
    ],
    createdAt: "2026-01-01T00:00:00Z",
    updatedAt: "2026-01-01T00:00:00Z",
  },
