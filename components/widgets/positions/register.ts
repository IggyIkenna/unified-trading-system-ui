...
registerPresets("positions", [
  {
    ...
    isPreset: true,
    layouts: [
      { widgetId: "positions-kpi-strip", instanceId: "positions-kpi-strip-1", x: 0, y: 0, w: 24, h: 2 },
      { widgetId: "positions-table", instanceId: "positions-table-1", x: 0, y: 2, w: 24, h: 10 },
    ],
  ...
  },
  {
    ...
    isPreset: true,
    layouts: [
      { widgetId: "positions-kpi-strip", instanceId: "positions-kpi-strip-full", x: 0, y: 0, w: 24, h: 2 },
      { widgetId: "positions-table", instanceId: "positions-table-full", x: 0, y: 2, w: 24, h: 8 },
    ],
    createdAt: "2026-01-01T00:00:00Z",
    updatedAt: "2026-01-01T00:00:00Z",
  },
