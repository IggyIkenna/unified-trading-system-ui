...
import {
  FlaskConical, Play, Bell, FileText, CheckCircle2, TrendingUp,
  Brain, Shield, Zap, Database,
} from "lucide-react"
...
const MOCK_ACTIVITY: ActivityEvent[] = [
  ...
  },
  {
    ...
    icon: TrendingUp, title: "Strategy Alpha-7 live on Binance",
    description: "3 instruments active, P&L +$12.4K since deployment",
    timestamp: "14 min ago", href: "/trading",
  },
  {
  ...
  },
  {
    ...
    icon: FileText, title: "Monthly P&L report generated",
    description: "Alpha Capital — March 2026 performance attribution ready",
    timestamp: "6h ago", href: "/reports",
  },
  {
    id: "act-7", stage: "Reconcile", stageColor: "text-yellow-400",
    icon: CheckCircle2, title: "Settlement completed",
    description: "Alpha Capital profit share $312K settled to Barclays",
    timestamp: "1d ago", href: "/reports",
  },
  {
  ...
  return (
    <div className="space-y-1">
      {events.map((event) => {
        ...
        if (event.href) {
          return <Link key={event.id} href={event.href} className="block">{content}</Link>
        }
