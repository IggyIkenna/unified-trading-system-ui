...
const STAGES = [
  {
    num: "1",
    name: "Acquire",
    short: "Ingest, normalise, validate",
    color: "sky",
  ...
  },
  {
    num: "2",
    name: "Build",
    short: "Research, train, simulate",
    color: "violet",
    borderClass: "border-violet-400/30",
    bgClass: "bg-violet-400/5",
    hoverBorder: "border-violet-400/70",
    textClass: "text-violet-400",
    detail:
      "Train ML models to predict price direction, volatility, or regime. Configure trading signals and optimise parameters. Design strategies that span venues and asset classes.",
    services: ["ML Model Training", "Signal Configuration", "Strategy Design"],
    example:
      "Train a BTC direction model using 6 years of cross-venue data, then configure a signal-to-trade pipeline that triggers on model predictions.",
  },
  {
    num: "3",
    name: "Promote",
    short: "Review, approve, deploy",
    color: "amber",
    borderClass: "border-amber-400/30",
    bgClass: "bg-amber-400/5",
    hoverBorder: "border-amber-400/70",
  ...
  },
  {
    num: "5",
    name: "Execute",
    short: "Algorithms, routing, best-ex",
    color: "teal",
  ...
  },
  {
    num: "8",
    name: "Report",
    short: "Attribute, audit, disclose",
    color: "slate",
    borderClass: "border-slate-400/30",
    bgClass: "bg-slate-400/5",
    hoverBorder: "border-slate-400/70",
