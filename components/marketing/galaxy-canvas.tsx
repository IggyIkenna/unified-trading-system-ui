...
const NODES = [
  ...
  { label: "Sports",      sub: "Betfair · Pinnacle",  color: "#fbbf24", fill: "#141003" },
  { label: "Predictions", sub: "Polymarket · Kalshi", color: "#fb7185", fill: "#140508" },
]

// Fixed positions as fractions of W×H, matching the reference image pentagon
const POS = [
  { fx: 0.17, fy: 0.38 }, // TradFi      — left mid
  { fx: 0.50, fy: 0.17 }, // CeFi        — top center
  { fx: 0.83, fy: 0.38 }, // DeFi        — right mid
  { fx: 0.26, fy: 0.80 }, // Sports      — bottom left
  { fx: 0.74, fy: 0.80 }, // Predictions — bottom right
]
