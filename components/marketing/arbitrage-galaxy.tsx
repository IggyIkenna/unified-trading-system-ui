...
const NODES = [
  { id: "tradfi",      label: "TradFi",     sub: "CME · ICE",           color: "#22d3ee", fill: "#061820", fx: 0.16, fy: 0.36 },
  { id: "cefi",        label: "CeFi",        sub: "Binance · OKX",       color: "#4ade80", fill: "#061a0f", fx: 0.50, fy: 0.19 },
  { id: "defi",        label: "DeFi",        sub: "Uniswap · Aave",      color: "#a78bfa", fill: "#100a20", fx: 0.84, fy: 0.36 },
  { id: "sports",      label: "Sports",      sub: "Betfair · Pinnacle",  color: "#fbbf24", fill: "#1a1205", fx: 0.24, fy: 0.80 },
  { id: "predictions", label: "Predictions", sub: "Polymarket · Kalshi", color: "#fb7185", fill: "#1a060c", fx: 0.73, fy: 0.80 },
]
    ...
    function renderFrame(t: number) {
      ...
      if (pausing) {
        ...
        for (let i = 8; i >= 0; i--) {
          ...
          ctx.fillStyle = conn.color + Math.floor(ta * 255).toString(16).padStart(2, "0")
          ctx.fill()
        }
      ...
      for (const node of NODES) {
        ...
        const titleSize = Math.round(R * 0.30)
        ...
        ctx.fillText(node.sub, x, y + R * 0.30)
      }
    }
