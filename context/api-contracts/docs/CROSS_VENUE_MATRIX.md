...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------ |
| **Tardis**        | BINANCE-SPOT, BINANCE-FUTURES, COINBASE-SPOT, DERIBIT, BYBIT-SPOT, BYBIT-FUTURES, OKX-SPOT, OKX-FUTURES, OKX-SWAP, BITFINEX-SPOT, BITSTAMP-SPOT, HUOBI-SPOT, HUOBI-FUTURES, GATEIO-SPOT, GATEIO-FUTURES, PHEMEX-FUTURES | Historical CeFi; exchanges, instruments, trades, book              |
