"""Canonical prediction market schemas — mapping, categorization, and cross-venue matching."""

from __future__ import annotations

from .prediction_mapping import CanonicalPredictionMarket as CanonicalPredictionMarket
