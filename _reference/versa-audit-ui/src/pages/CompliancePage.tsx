...
type ComplianceTab = "summary" | "orphans" | "tts" | "errors";
...
export function CompliancePage() {
  const [activeTab, setActiveTab] = useState<ComplianceTab>("summary");

  const TABS: { id: ComplianceTab; label: string; count?: number }[] = [
      ...
      <div className="flex gap-2 border-b border-[var(--color-border)] pb-0">
        {TABS.map((tab) => (
          <Button
            ...
            className={`border-b-2 rounded-none -mb-px ${
              activeTab === tab.id
