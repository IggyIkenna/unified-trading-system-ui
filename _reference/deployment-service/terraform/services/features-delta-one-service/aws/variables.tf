# Variables for features-delta-one-service on AWS
...
variable "job_name" {
  ...
  type        = string
  default     = "features-delta-one-service"
}
...
variable "s3_bucket_tradfi" {
  description = "S3 bucket for TRADFI candles"
  type        = string
}
...
variable "features_bucket_cefi" {
  description = "S3 bucket for CEFI features output"
  type        = string
}

variable "features_bucket_tradfi" {
  description = "S3 bucket for TRADFI features output"
  type        = string
}

variable "features_bucket_defi" {
  description = "S3 bucket for DEFI features output"
  type        = string
}
...
variable "workflow_name" {
  ...
  type        = string
  default     = "features-delta-one-service-daily"
}
