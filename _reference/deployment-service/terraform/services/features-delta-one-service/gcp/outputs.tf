# Outputs for features-delta-one-service Terraform configuration
...
output "backfill_example_command" {
  ...
  value       = "gcloud workflows run ${var.backfill_workflow_name} --location=${var.region} --data='{\"start_date\":\"2020-01-01\",\"end_date\":\"2026-01-25\",\"categories\":[\"CEFI\",\"TRADFI\",\"DEFI\"],\"feature_groups\":[\"all\"]}'"
}
