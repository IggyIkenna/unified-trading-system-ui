# Variables for pnl-attribution-service on AWS
...
variable "job_name" {
  ...
  type        = string
  default     = "pnl-attribution-service"
}
...
variable "pnl_attribution_bucket" {
  description = "S3 bucket for PnL attribution results"
  type        = string
}
