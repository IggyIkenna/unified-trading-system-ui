# Variables for risk-and-exposure-service Terraform configuration
...
variable "job_name" {
  ...
  type        = string
  default     = "risk-and-exposure-service-job"
}
...
variable "backfill_workflow_name" {
  ...
  type        = string
  default     = "risk-and-exposure-service-backfill"
}

variable "schedule" {
  description = "Cron schedule (default: 17:00 PM UTC - after execution-services)"
  type        = string
  default     = "0 17 * * *"
}
