...
variable "job_name" {
  ...
  type        = string
  default     = "features-multi-timeframe-service-job"
}
...
variable "backfill_workflow_name" {
  ...
  type        = string
  default     = "features-multi-timeframe-service-backfill"
}

variable "schedule" {
  description = "Cron schedule (default: 12:00 PM UTC - after features-delta-one at 11:00)"
  type        = string
  default     = "0 12 * * *"
}
