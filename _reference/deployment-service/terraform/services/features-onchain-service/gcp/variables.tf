# Variables for features-onchain-service Terraform configuration
...
variable "job_name" {
  ...
  type        = string
  default     = "features-onchain-service-job"
}
...
variable "backfill_workflow_name" {
  ...
  type        = string
  default     = "features-onchain-service-backfill"
}

variable "schedule" {
  description = "Cron schedule (default: 11:30 AM UTC - after other features)"
  type        = string
  default     = "30 11 * * *"
}
