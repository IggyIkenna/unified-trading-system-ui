# Outputs for features-onchain-service Terraform configuration
...
output "backfill_example_command" {
  ...
  value       = "gcloud workflows run ${var.backfill_workflow_name} --location=${var.region} --data='{\"start_date\":\"2020-12-18\",\"end_date\":\"2026-01-25\",\"categories\":[\"CEFI\",\"DEFI\"],\"feature_groups\":[\"macro_sentiment\"]}'"
}
