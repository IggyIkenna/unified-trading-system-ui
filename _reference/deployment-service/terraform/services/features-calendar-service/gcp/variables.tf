# Variables for features-calendar-service Terraform configuration
...
variable "job_name" {
  ...
  type        = string
  default     = "features-calendar-service-job"
}
...
variable "backfill_workflow_name" {
  ...
  type        = string
  default     = "features-calendar-service-backfill"
}

variable "schedule" {
  description = "Cron schedule (default: 8:30 AM UTC - after instruments-service)"
  type        = string
  default     = "30 8 * * *"
}
