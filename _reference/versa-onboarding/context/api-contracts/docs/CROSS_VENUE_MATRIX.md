...
| ----------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------ |
| **Tardis**        | BINANCE-SPOT, BINANCE-FUTURES, COINBASE-SPOT, DERIBIT, BYBIT-SPOT, BYBIT-FUTURES, OKX-SPOT, OKX-FUTURES, OKX-SWAP, BITFINEX-SPOT, GEMINI-SPOT, BITSTAMP-SPOT, HUOBI-SPOT, HUOBI-FUTURES, GATEIO-SPOT, GATEIO-FUTURES, PHEMEX-SPOT, PHEMEX-FUTURES | Historical CeFi; exchanges, instruments, trades, book              |
