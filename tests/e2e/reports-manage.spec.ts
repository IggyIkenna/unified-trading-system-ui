...
test.describe("Reports Service", () => {
  ...
  test("Reconciliation page renders drift panel and history", async ({ page }) => {
    ...
    // Should have summary cards
    await expect(page.locator("text=Total Breaks").or(page.locator("text=Reconciliation"))).toBeVisible({
      timeout: 10000,
    });
...
test.describe("Manage Service", () => {
  test("Clients page renders client list", async ({ page }) => {
    ...
    await expect(page.locator("text=Client Management").or(page.locator("text=Clients"))).toBeVisible({
      timeout: 10000,
    });
  ...
  test("Mandates page renders mandate table", async ({ page }) => {
    ...
    await expect(page.locator("text=Investment Mandates").or(page.locator("text=Mandates"))).toBeVisible({
      timeout: 10000,
    });
